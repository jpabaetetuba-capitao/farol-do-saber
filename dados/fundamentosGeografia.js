...
const fundamentosGeografia = [
    {
        "texto": "Em um município amazônico, a abertura de uma estrada, a ampliação de um porto e a chegada de internet alteraram circulação, preço da terra, deslocamento de trabalhadores e uso do solo. O caso não pode ser explicado apenas pelo relevo ou pelo clima.",
    ...
    {
        "texto": "A expansão do comércio internacional foi favorecida por portos integrados, telecomunicações, satélites, contêineres e sistemas digitais de pagamento. Apesar disso, os ganhos não chegam igualmente a todos os países e grupos sociais.",
    ...
    {
        "texto": "A difusão das tecnologias de comunicação permite contato rápido entre lugares distantes, mas nem todos possuem infraestrutura, renda e domínio técnico para acessar esses recursos. A modernização, portanto, é seletiva.",
        "pergunta": "Com base no texto, é correto afirmar que a globalização:",
        "alternativas": [
            "elimina automaticamente desigualdades socioespaciais.",
            "intensifica conexões, mas pode ampliar diferenças entre lugares.",
            "impede a circulação internacional de informações e capitais.",
            "ocorre apenas em áreas sem infraestrutura técnica.",
            "representa o retorno ao meio natural sem ciência e tecnologia."
        ],
        "correta": 1,
        "feedbackAcerto": "Correto. A globalização aproxima lugares por redes e fluxos, porém sua apropriação é desigual e seletiva.",
        "feedbackErro": "A alternativa correta é: intensifica conexões, mas pode ampliar diferenças entre lugares.. A globalização aproxima lugares por redes e fluxos, porém sua apropriação é desigual e seletiva.",
        "dicaBanca": "Desconfie de alternativas com 'automaticamente', 'todos' e 'sempre'."
    },
    {
    ...
    {
        "texto": "Ao observar uma praça, o estudante identifica árvores, bancos, fluxo de pessoas, prédios, placas comerciais e marcas de reformas recentes. Ele descreve aquilo que é percebido diretamente.",
    ...
    {
        "texto": "Em uma avenida central, casarões antigos convivem com prédios comerciais, cabos de fibra óptica e novos usos dos imóveis. A imagem atual reúne objetos de tempos diferentes.",
    ...
    {
        "texto": "Uma fotografia de área costeira mostra manguezais, embarcações, casas sobre palafitas, trapiches, redes de pesca e antenas de telecomunicação. Parte é natural; parte resulta de trabalho, cultura e técnica.",
        "pergunta": "A paisagem descrita deve ser compreendida como:",
        "alternativas": [
    ...
    {
        "texto": "Uma ponte, um porto, uma escola, uma estrada e uma rede de internet são objetos materiais. Eles ganham sentido quando usados por empresas, estudantes, governos, moradores e trabalhadores.",
        "pergunta": "A formulação se aproxima da ideia de Milton Santos de que o espaço geográfico é formado por:",
        "alternativas": [
            "sistemas de objetos e sistemas de ações.",
            "paisagens naturais sem intervenção social.",
            "formas vazias sem uso humano.",
            "coordenadas astronômicas e fusos horários.",
            "climas e biomas sem técnica."
        ],
        "correta": 0,
        "feedbackAcerto": "Correto. Para Milton Santos, o espaço reúne objetos materiais e ações sociais de forma indissociável.",
        "feedbackErro": "A alternativa correta é: sistemas de objetos e sistemas de ações.. Para Milton Santos, o espaço reúne objetos materiais e ações sociais de forma indissociável.",
        "dicaBanca": "Milton Santos: objetos + ações."
    },
    {
    ...
    {
        "texto": "Um mesmo estado pode ser dividido em regiões turísticas, regiões de saúde, regiões hidrográficas ou regiões econômicas. Cada recorte atende a uma finalidade específica.",
        "pergunta": "A partir do texto, conclui-se corretamente que uma região:",
        "alternativas": [
    ...
    {
        "texto": "O aumento do preço de alimentos em uma cidade pode estar ligado à seca regional, ao custo internacional dos combustíveis, à logística nacional e à renda das famílias no bairro.",
        "pergunta": "A abordagem geográfica indicada no texto é a análise:",
        "alternativas": [
            "multiescalar.",
            "exclusivamente astronômica.",
            "apenas cartométrica.",
            "naturalista absoluta.",
            "sem relação entre lugares."
        ],
        "correta": 0,
        "feedbackAcerto": "Correto. A análise multiescalar relaciona processos locais, regionais, nacionais e globais.",
        "feedbackErro": "A alternativa correta é: multiescalar.. A análise multiescalar relaciona processos locais, regionais, nacionais e globais.",
        "dicaBanca": "Local + regional + global = análise multiescalar."
    },
    {
        "texto": "A Geografia Crítica questiona a ideia de que o espaço seja cenário neutro. Ela busca compreender desigualdades, conflitos, interesses econômicos e atuação do Estado na produção espacial.",
    ...
    {
        "texto": "Em uma região, primeiro predominavam técnicas simples adaptadas aos ritmos naturais. Depois surgiram máquinas, energia elétrica, rodovias, telecomunicações, satélites e plataformas digitais.",
        "pergunta": "A sequência histórica apresentada corresponde à passagem do:",
        "alternativas": [
            "meio natural ao meio técnico-científico-informacional.",
            "território ao fuso horário.",
            "lugar à latitude absoluta.",
            "clima equatorial à projeção cilíndrica.",
            "possibilismo ao imobilismo natural."
        ],
        "correta": 0,
        "feedbackAcerto": "Correto. A sequência mostra a crescente incorporação de técnica, ciência e informação na organização do espaço.",
        "feedbackErro": "A alternativa correta é: meio natural ao meio técnico-científico-informacional.. A sequência mostra a crescente incorporação de técnica, ciência e informação na organização do espaço.",
        "dicaBanca": "Satélites, redes digitais e telecomunicações indicam meio técnico-científico-informacional."
    },
    {
    ...
    {
        "texto": "A instalação de uma grande obra de infraestrutura pode facilitar deslocamentos e gerar empregos, mas também pode expulsar moradores, alterar formas de trabalho e reforçar desigualdades.",
        "pergunta": "A leitura geográfica adequada do texto é que a técnica:",
        "alternativas": [
    ...
    {
        "texto": "Uma empresa controla a marca em um país, compra matérias-primas em outro, monta produtos em um terceiro e vende pela internet para consumidores de diversos continentes.",
        "pergunta": "Esse exemplo evidencia:",
        "alternativas": [
            "a fragmentação e articulação do espaço pela economia globalizada.",
            "o fim das redes mundiais de produção.",
            "a inexistência de hierarquias entre territórios.",
            "o retorno exclusivo à produção local autossuficiente.",
            "a ausência de tecnologia na circulação de mercadorias."
        ],
        "correta": 0,
        "feedbackAcerto": "Correto. A produção global articula territórios, fragmenta etapas e cria hierarquias na divisão territorial do trabalho.",
        "feedbackErro": "A alternativa correta é: a fragmentação e articulação do espaço pela economia globalizada.. A produção global articula territórios, fragmenta etapas e cria hierarquias na divisão territorial do trabalho.",
        "dicaBanca": "Cadeia produtiva em vários países = globalização e redes."
    },
    {
    ...
    {
        "texto": "Uma área turística é divulgada por fotografias de praias, florestas e hotéis. O material destaca a imagem visual, mas oculta conflitos fundiários e trabalho precário.",
    ...
    {
        "texto": "A retirada de vegetação para loteamentos altera drenagem, temperatura local, risco de alagamento, circulação e valorização imobiliária. O fenômeno é ambiental, social, econômico e político.",
    ...
    {
        "texto": "Duas comunidades vivem em áreas com condições naturais semelhantes, mas uma desenvolve agricultura irrigada, outra turismo comunitário e outra preservação com pesquisa. As escolhas dependem de cultura, técnica e organização social.",
        "pergunta": "O exemplo reforça a ideia de que:",
        "alternativas": [
            "o meio natural impõe uma única possibilidade de desenvolvimento.",
            "as sociedades podem produzir usos distintos a partir de possibilidades oferecidas pelo meio.",
            "a cultura e a técnica não interferem no espaço.",
            "todos os lugares com mesmo clima terão economia idêntica.",
            "a Geografia deve ignorar a ação humana."
        ],
        "correta": 1,
        "feedbackAcerto": "Correto. O exemplo corresponde ao possibilismo: o meio oferece condições, mas a sociedade define usos.",
        "feedbackErro": "A alternativa correta é: as sociedades podem produzir usos distintos a partir de possibilidades oferecidas pelo meio.. O exemplo corresponde ao possibilismo: o meio oferece condições, mas a sociedade define usos.",
        "dicaBanca": "Mesmo meio, usos diferentes = crítica ao determinismo."
    },
    {
    ...
    {
        "texto": "Vidal de La Blache valorizava a capacidade humana de escolher entre possibilidades oferecidas pelo meio, considerando modos de vida e adaptação social às condições ambientais.",
        "pergunta": "A corrente associada a Vidal de La Blache é o:",
        "alternativas": [
            "possibilismo geográfico.",
            "determinismo ambiental rígido.",
            "neopositivismo quantitativo.",
            "urbanismo tecnocrático.",
            "ambientalismo sem sociedade."
        ],
        "correta": 0,
        "feedbackAcerto": "Correto. Vidal de La Blache é referência do possibilismo geográfico.",
        "feedbackErro": "A alternativa correta é: possibilismo geográfico.. Vidal de La Blache é referência do possibilismo geográfico.",
        "dicaBanca": "Vidal costuma aparecer como contraponto ao determinismo."
    },
    {
    ...
    {
        "texto": "Uma professora compara centro comercial, periferia, porto e zona rural do município, observando circulação, infraestrutura, moradia, trabalho e desigualdade. A proposta vai além da descrição.",
        "pergunta": "A proposta didática está alinhada à ideia de que a Geografia deve:",
        "alternativas": [
            "descrever nomes de lugares sem problematização.",
            "relacionar formas espaciais a processos sociais, econômicos e políticos.",
            "evitar o estudo do espaço vivido dos estudantes.",
            "substituir análise por cópia de mapas.",
            "tratar cidade e campo como realidades sem conexão."
        ],
        "correta": 1,
        "feedbackAcerto": "Correto. A proposta relaciona formas e processos, considerando desigualdades e usos do espaço.",
        "feedbackErro": "A alternativa correta é: relacionar formas espaciais a processos sociais, econômicos e políticos.. A proposta relaciona formas e processos, considerando desigualdades e usos do espaço.",
        "dicaBanca": "Ensino de Geografia deve interpretar, não apenas descrever."
    },
    {
    ...
    {
        "texto": "Considere as afirmações: I. Paisagem corresponde apenas a elementos naturais preservados. II. Território envolve relações de poder, controle e apropriação do espaço. III. Lugar refere-se ao espaço vivido, associado a identidade e pertencimento.",
    ...
    {
        "texto": "Um rio pode ser visto como paisagem por suas formas visíveis, como lugar pelas memórias de uma comunidade, como território quando há disputa por uso e como região quando delimita uma bacia.",
        "pergunta": "A leitura correta do texto é que:",
        "alternativas": [
            "as categorias geográficas são excludentes e não podem analisar o mesmo fenômeno.",
            "um mesmo fenômeno espacial pode ser interpretado por diferentes categorias, conforme o enfoque.",
            "todo rio deve ser analisado apenas pela cartografia matemática.",
            "paisagem, lugar, território e região possuem exatamente o mesmo significado.",
            "a Geografia não trabalha com conceitos."
        ],
        "correta": 1,
        "feedbackAcerto": "Correto. As categorias geográficas podem se complementar na análise de um mesmo fenômeno, conforme o foco do problema.",
        "feedbackErro": "A alternativa correta é: um mesmo fenômeno espacial pode ser interpretado por diferentes categorias, conforme o enfoque.. As categorias geográficas podem se complementar na análise de um mesmo fenômeno, conforme o foco do problema.",
        "dicaBanca": "Categorias não são sinônimas, mas podem se articular."
    },
    {
        "texto": "Uma reportagem mostra moradores removidos de área central para construção de empreendimento. O texto destaca valorização imobiliária, atuação do poder público, interesses privados e mudança na vida cotidiana.",
    ...
    {
        "texto": "Analise as afirmações: I. O espaço geográfico é produzido historicamente. II. As técnicas influenciam a forma como a sociedade usa e transforma a natureza. III. No período atual, informação e redes têm papel relevante na organização do território.",
        "pergunta": "Está correto o que se afirma em:",
        "alternativas": [
            "I, apenas.",
            "I, II e III.",
    ...
    {
        "texto": "A delimitação de uma reserva, de uma terra indígena, de uma área militar ou de uma zona de mineração envolve normas, limites, autoridade e conflitos de interesse.",
        "pergunta": "Esses exemplos têm em comum a presença de:",
        "alternativas": [
            "relações territoriais de poder e controle.",
            "fenômenos astronômicos de translação.",
            "paisagens sem qualquer ação social.",
            "regiões sem critérios de delimitação.",
            "lugares sem identidade ou uso."
        ],
        "correta": 0,
        "feedbackAcerto": "Correto. Todos os exemplos envolvem controle, normas, limites e disputa, elementos próprios do território.",
        "feedbackErro": "A alternativa correta é: relações territoriais de poder e controle.. Todos os exemplos envolvem controle, normas, limites e disputa, elementos próprios do território.",
        "dicaBanca": "Território não é só país; é espaço apropriado e controlado."
    }
];
