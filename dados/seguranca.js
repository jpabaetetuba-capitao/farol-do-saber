...
const seguranca = [
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "Acesso administrativo permanente a todos os recursos.",
            "A mesma senha compartilhada para simplificar suporte.",
            "Permissão de instalar qualquer programa sem controle.",
            "Acesso irrestrito enquanto estiverem na rede interna."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            "Todo usuário dentro da rede é sempre confiável.",
            "Nenhum acesso deve ser confiável automaticamente, devendo haver verificação contínua.",
            "Senhas podem ser removidas se houver firewall.",
            "Backups substituem autenticação.",
            "Criptografia é desnecessária em redes privadas."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            "Apenas senha e nome de usuário.",
            "Somente endereço IP e navegador.",
            "Algo que o usuário sabe, possui ou é.",
            "Backup, firewall e antivírus.",
            "HTTP, DNS e FTP."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            "Hash sempre recupera o texto original com senha.",
            "Criptografia serve apenas para compactar arquivos.",
            "Hash é usado somente em imagens.",
            "Criptografia é reversível com chave adequada; hash é projetado para verificação sem reversão prática.",
            "Ambos têm sempre a mesma finalidade."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            "Permitir que o administrador leia a senha original.",
            "Substituir a necessidade de hash.",
            "Aumentar a velocidade do teclado.",
            "Enviar senhas por e-mail com segurança.",
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "Que o arquivo não possa ser copiado.",
            "Que o documento fique invisível na rede.",
            "Que o antivírus esteja atualizado.",
            "Que o arquivo seja compactado sem perda."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            "Dispensa qualquer segredo compartilhado.",
            "Usa a mesma chave para cifrar e decifrar, exigindo proteção no compartilhamento da chave.",
            "Utiliza sempre uma chave pública e uma privada.",
            "Só funciona para imagens.",
            "É exclusiva de redes Wi-Fi domésticas."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            "Garantir que todos os usuários possam editar o arquivo.",
            "Impedir que um arquivo seja salvo em PDF.",
    ...
    },
    {
        ...
        "alternativas": [
            "É sempre feito sem e-mail.",
            "É um tipo de backup incremental.",
            "É usado apenas para proteger senhas.",
            "É direcionado a uma pessoa, cargo ou organização específica, com maior personalização.",
            "Não envolve engenharia social."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "Realizar busca exata no Google.",
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "Pagar resgate antecipadamente.",
            "Desativar todas as atualizações de segurança.",
            "Usar a mesma senha em todos os serviços.",
            "Compartilhar arquivos executáveis por e-mail."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            "Atuar apenas como antivírus local.",
            "Avaliar o estado das conexões, e não apenas pacotes isolados.",
            "Substituir a criptografia HTTPS.",
    ...
    },
    {
        ...
        "alternativas": [
            "IDS criptografa arquivos; IPS faz backup.",
            "IDS é navegador; IPS é sistema operacional.",
            "IDS detecta/alerta; IPS pode atuar bloqueando ou prevenindo tráfego suspeito.",
            "IDS substitui senhas; IPS substitui usuários.",
    ...
    },
    {
        ...
        "alternativas": [
            "A comunicação possa ser encapsulada.",
            "O acesso remoto possa ser autenticado.",
            "A conexão use túnel criptografado.",
            "O computador do usuário esteja livre de malware ou configurado com segurança.",
            "O tráfego passe por servidor corporativo."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            "Criar senhas aleatórias para todos os usuários.",
            "Converter documentos em PDF.",
            "Desfragmentar exclusivamente SSDs.",
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "O impacto financeiro já ocorrido.",
            "Um usuário autorizado realizando login normal.",
            "A cópia de segurança mais recente.",
    ...
    },
    {
        ...
        "alternativas": [
            "Apenas troca de fonte do Word.",
            "Configuração de fórmulas em planilhas.",
            "Restrição de acesso a salas de servidores e proteção contra remoção indevida de equipamentos.",
            "Uso de filtros de busca na Internet.",
            "Criação de slides com transições."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            "Divulgar publicamente todos os dados afetados sem análise.",
            "Aumentar privilégios de todos os usuários.",
            "Remover backups para evitar conflito.",
            "Limitar a propagação ou o impacto do incidente antes da erradicação e recuperação.",
            "Desativar logs para economizar espaço."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            "Coletar todos os dados possíveis por segurança.",
            "Remover senhas fortes do sistema.",
            "Compartilhar dados sem controle entre setores.",
            "Armazenar indefinidamente qualquer informação coletada.",
    ...
    },
    {
        ...
        "alternativas": [
            "divulgar imediatamente todos os dados internos.",
            "aumentar privilégios dos usuários impactados.",
            "desativar a coleta de evidências.",
            "remover a causa do incidente após sua contenção.",
            "negar a existência de qualquer falha."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            "o tempo de vida de uma senha temporária.",
            "a velocidade máxima de um cabo de rede.",
            "a quantidade de antivírus instalados por estação.",
            "o ponto máximo de perda de dados aceitável após uma interrupção.",
            "o número de usuários administradores do domínio."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "algo que o sistema removeu.",
            "algo que o arquivo compactou.",
            "algo que o usuário possui.",
            "algo que a rede roteou."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            "somente o provedor responde por qualquer configuração do cliente.",
            "somente o usuário final controla a infraestrutura física.",
            "nenhuma parte precisa aplicar controles de segurança.",
            "provedor e cliente possuem deveres distintos na proteção do ambiente.",
            "todos os dados ficam públicos automaticamente."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            "velocidade de download e compressão automática.",
            "autenticidade, integridade e não repúdio do documento.",
            "anonimato absoluto do remetente da mensagem.",
            "exclusão definitiva de cópias não autorizadas.",
            "bloqueio de qualquer ataque contra o computador."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            "recuperar diretamente o texto original de uma senha.",
            "verificar integridade por meio de uma impressão digital dos dados.",
            "aumentar a capacidade física do disco rígido.",
            "criar automaticamente uma cópia de segurança completa.",
            "substituir a autenticação de usuários em todos os casos."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "erro de fórmula em planilhas eletrônicas.",
            "falha de alinhamento em documentos de texto.",
            "perda de sinal em cabo HDMI do monitor.",
            "ausência de estilos em sumário automático."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            "remove definitivamente qualquer possibilidade técnica de vínculo.",
            "transforma dados em arquivos executáveis do Windows.",
            "apaga todos os backups do ambiente principal.",
            "a reidentificação ainda pode ser possível mediante informação adicional separada.",
            "substitui completamente políticas de acesso."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "garantir que o site nunca contenha conteúdo fraudulento.",
            "substituir a necessidade de senhas dos usuários.",
            "armazenar todos os arquivos baixados pelo navegador.",
    ...
    },
    {
        ...
        "alternativas": [
            "eliminar a necessidade de qualquer política de acesso.",
            "transformar documentos em arquivos executáveis.",
            "garantir que dados nunca precisem de backup.",
            "aplicar controles de proteção compatíveis com a sensibilidade dos dados.",
            "substituir criptografia por nomes de pasta."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            "um cabo de rede romper por desgaste físico.",
            "alguém se passar por suporte e solicitar credenciais ao usuário.",
            "um disco rígido falhar por defeito mecânico.",
            "um arquivo ser compactado com senha forte.",
            "um servidor reiniciar após atualização autorizada."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "duas chaves públicas sem chave privada correspondente.",
            "um algoritmo de compactação sem proteção de sigilo.",
            "senhas salvas em texto claro para facilitar acesso.",
            "certificados usados apenas para organizar arquivos."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            "apenas o modelo do monitor usado na empresa.",
            "somente a extensão de um arquivo compactado.",
            "informação relacionada a saúde, biometria ou origem racial, entre outras categorias protegidas.",
            "exclusivamente o tamanho de uma pasta local.",
            "apenas a versão de um navegador instalado."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            "aumentar a resolução do monitor do servidor.",
            "definir a cor dos ícones da área de trabalho.",
            "converter arquivos DOCX em PDF automaticamente.",
            "permitir ou negar tráfego conforme critérios definidos.",
            "substituir certificados digitais expirados."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            "a instalação de atualizações do sistema operacional.",
            "a criação de cópias compactadas de documentos.",
            "a responsabilização das ações realizadas no sistema.",
            "a identificação do tipo de memória do equipamento.",
            "a navegação em páginas que utilizam HTTPS."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            "impede que o sistema realize qualquer autenticação.",
            "torna obrigatório o uso de fibra óptica na rede.",
            "elimina a necessidade de controle de permissões.",
            "aumenta automaticamente a largura de banda disponível.",
    ...
    },
    {
        ...
        "alternativas": [
            "trocam cabos de rede por cabos HDMI.",
            "renomeiam arquivos para alterar seu conteúdo.",
            "testam credenciais vazadas de um serviço em outros sistemas.",
            "instalam fontes tipográficas em documentos.",
            "usam OCR para digitalizar formulários."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            "alterar fisicamente cabos de rede para aumentar alcance.",
            "criar cópia incremental de arquivos modificados.",
            "testar muitas combinações até encontrar uma credencial válida.",
            "usar estilos do Word para gerar sumário.",
            "compactar anexos antes do envio por e-mail."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            "uma chave única compartilhada por todos os usuários.",
            "um arquivo ZIP protegido apenas por compressão.",
            "um token físico dispensável em qualquer autenticação.",
            "uma senha de rede gravada em texto aberto.",
    ...
    },
    {
        ...
        "alternativas": [
            "redes públicas impedem qualquer autenticação de usuário.",
            "o tráfego e o ambiente podem estar sob controle de terceiros não confiáveis.",
            "todo Wi-Fi público apaga automaticamente os arquivos.",
            "navegadores deixam de suportar certificados digitais.",
            "o teclado passa a registrar somente letras maiúsculas."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            "uma mensagem é arquivada em pasta local.",
            "um anexo é compactado antes do envio.",
            "o remetente é falsificado para aparentar outra origem.",
            "o usuário limpa o histórico do navegador.",
            "um documento é assinado digitalmente de forma válida."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            "substituir toda autenticação por login automático.",
            "aumentar o clock do processador do servidor.",
            "remover todos os controles de acesso existentes.",
    ...
    },
    {
        ...
        "alternativas": [
            "exclusivamente sinais luminosos de fibra óptica.",
            "apenas planilhas com fórmulas condicionais.",
            "listas de palavras e combinações comuns para tentar acesso.",
            "imagens compactadas em formato PNG.",
            "rotinas de impressão frente e verso."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            "a necessidade de qualquer controle de acesso.",
            "a possibilidade de alterações indevidas e instalação não autorizada.",
            "a qualidade da criptografia de disco.",
            "a capacidade de fazer login com usuário comum.",
            "a validade de certificados digitais legítimos."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            "preferência por armazenar tudo de forma permanente.",
            "quantidade de cores usadas no painel do sistema.",
            "tipo de fonte escolhida para documentos internos.",
            "ordem dos ícones exibidos na área de trabalho.",
    ...
    },
    {
        ...
        "alternativas": [
            "usuários anônimos sem qualquer função corporativa.",
            "equipamentos de impressão conectados por USB.",
            "arquivos compactados armazenados localmente.",
            "executivos, gestores ou pessoas com alto poder de decisão.",
            "redes pessoais formadas por Bluetooth."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            "é o único padrão compatível com WPA3.",
            "impede qualquer tipo de conexão sem fio.",
            "funciona somente com fibra óptica monomodo.",
            "dispensa completamente o uso de chaves.",
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "impede qualquer conexão com redes sem fio.",
            "elimina a necessidade de políticas de segurança.",
            "garante que todos os dados fiquem públicos.",
            "substitui servidores por monitores externos."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            "compartilhar senhas no histórico para facilitar suporte.",
            "rastrear alterações, autores e histórico de arquivos do projeto.",
            "desativar revisão de código em sistemas críticos.",
            "garantir que todo bug seja explorável.",
            "remover logs de auditoria dos servidores."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            "bloquear todos os programas legítimos do sistema.",
            "permitir qualquer arquivo baixado da Internet.",
            "substituir senhas por nomes de usuário.",
            "criar cópias completas de todos os documentos.",
    ...
    },
    {
        ...
        "alternativas": [
            "um arquivo é renomeado sem mudar conteúdo.",
            "um backup diferencial é concluído com êxito.",
            "um monitor altera automaticamente o brilho.",
            "uma impressora conclui a fila de impressão.",
    ...
    },
    {
        ...
        "alternativas": [
            "substituem tecnicamente todos os controles de rede.",
            "dispensam senhas fortes em sistemas críticos.",
            "muitos incidentes exploram comportamento humano e decisões equivocadas.",
            "eliminam a necessidade de backup testado.",
            "garantem imunidade total contra malware."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            "aumento automático do tamanho da tela.",
            "compressão sem perdas de qualquer vídeo.",
            "uso indevido de serviços e acesso a recursos associados à chave.",
            "remoção de todas as vulnerabilidades do sistema.",
            "substituição segura de backups off-line."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            "impede necessariamente todo incidente antes de começar.",
            "substitui o backup por cópias informais.",
            "identifica eventos ou indícios de violação após ou durante a ocorrência.",
            "elimina a necessidade de qualquer ação corretiva.",
            "remove permissões legítimas sem análise."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            "usar apenas um controle único considerado suficiente.",
            "remover autenticação para melhorar usabilidade.",
            "centralizar todas as senhas em documento público.",
            "desativar logs para preservar privacidade interna.",
    ...
    },
    {
        ...
        "alternativas": [
            "dispensa testes e controles posteriores em todos os casos.",
            "garante que senhas sejam armazenadas em texto claro.",
            "pode identificar falhas antes que cheguem ao ambiente de produção.",
            "aumenta a velocidade física do processador.",
            "substitui backups por comentários no código."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            "garantir que os dados fiquem disponíveis sem interrupção.",
            "ocultar todos os registros de acesso do sistema.",
            "permitir que qualquer usuário altere logs antigos.",
            "substituir a criptografia por senhas longas.",
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "colete todos os dados disponíveis para uso futuro incerto.",
            "mantenha dados indefinidamente sem justificativa.",
            "compartilhe bases inteiras por conveniência.",
            "dispense controle de acesso a informações pessoais."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            "atalhos coloridos para os programas mais usados.",
            "backups íntegros, testados e isolados do ambiente comprometido.",
            "monitores de maior resolução nos setores administrativos.",
            "documentos com cabeçalhos padronizados.",
            "conectores HDMI em todos os computadores."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            "eliminar toda tecnologia da organização.",
            "avaliar probabilidade e impacto para definir tratamento adequado.",
            "garantir que nenhum incidente jamais ocorra.",
            "substituir auditorias por opiniões informais.",
            "remover todos os controles de acesso existentes."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            "aumenta a segurança por exigir múltiplos fatores.",
            "bloqueia qualquer conexão não autorizada por padrão.",
            "contorna mecanismos normais de autenticação ou controle.",
            "gera cópias de segurança testadas automaticamente.",
            "remove todo software malicioso conhecido."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            "uma cópia única no mesmo computador de produção.",
            "três senhas iguais para todos os administradores.",
            "três cópias, em dois tipos de mídia, com uma fora do ambiente principal.",
            "dois antivírus e uma conta compartilhada.",
            "uma mídia local sempre conectada à máquina principal."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "apenas depois de ocorrer vazamento confirmado.",
            "somente quando o usuário solicitar suporte.",
            "exclusivamente no descarte do equipamento.",
            "apenas na impressão de documentos físicos."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            "aumentar a resolução das imagens do sistema.",
            "substituir a criptografia de dados sensíveis.",
            "garantir que qualquer entrada seja aceita sem análise.",
            "reduzir riscos de dados malformados ou comandos indevidos serem processados.",
            "remover toda autenticação dos usuários."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            "apaga logs antes de auditorias externas.",
            "fornece senhas administrativas a todos os funcionários.",
            "desativa autenticação para simplificar acesso.",
            "contrata seguro ou serviço especializado para compartilhar impactos.",
            "substitui backup por renomeação de arquivos."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            "desativar qualquer tipo de filtragem de tráfego.",
            "armazenar senhas em texto claro para auditoria.",
            "isolar serviços expostos ao público da rede interna sensível.",
            "substituir o backup completo por atalhos.",
            "permitir acesso irrestrito a estações internas."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "apenas superaquecimento de componentes internos.",
            "somente defeito físico em cabos metálicos.",
            "exclusivamente erro de fórmula em planilhas.",
            "apenas compactação inadequada de arquivos."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            "bloquear fisicamente portas USB do computador.",
            "detectar eventos suspeitos e gerar alertas para análise.",
            "substituir a autenticação multifator.",
            "realizar formatação automática do disco.",
            "criar documentos digitais assinados."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "criação de novos usuários locais.",
            "aumento automático de memória RAM.",
            "mudança da extensão de arquivos de texto.",
    ...
    },
    {
        ...
        "alternativas": [
            "a organização decide ignorar totalmente a ameaça.",
            ...
            "logs são apagados para simplificar auditoria.",
            "senhas são compartilhadas para acelerar atendimento."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "editar planilhas com fórmulas condicionais.",
            "conectar impressoras por rede sem fio.",
            "criar sumário automático em documento.",
            "converter imagens em texto por OCR."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "melhoria automática da criptografia local.",
            "aumento de memória cache do navegador.",
            "bloqueio físico da porta USB do computador.",
            "desfragmentação automática do disco rígido."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            "apenas um usuário digitando senha incorreta.",
            "exclusivamente defeito em fonte de alimentação.",
            "múltiplas fontes coordenadas gerando tráfego contra o alvo.",
            "somente cópia local de arquivos temporários.",
            "um único documento com macro legítima."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            "arquivo de imagem usado para ilustrar relatórios.",
            "sequência de slides de uma apresentação.",
            "cabo físico entre computador e roteador.",
    ...
    },
    {
        ...
        "alternativas": [
            "transforma o computador remoto em servidor DNS público.",
            "cria um túnel protegido entre o usuário e a rede da organização.",
            "impede que qualquer malware seja executado no dispositivo.",
            "dispensa autenticação e controle de permissões.",
            "aumenta automaticamente a capacidade do disco local."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            "aumentar o espaço livre no disco rígido.",
            "impedir que qualquer usuário erre a senha.",
            "substituir o firewall de borda.",
            "registrar eventos e permitir rastreamento de ações relevantes.",
            "converter automaticamente arquivos em PDF."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            "garante que todos os arquivos fiquem compactados.",
            "corrige falhas conhecidas antes que sejam exploradas indevidamente.",
            "substitui o treinamento de usuários por completo.",
            "remove a necessidade de backup periódico.",
            "permite que senhas sejam compartilhadas com segurança."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "destinados apenas a aumentar velocidade de download.",
            "criados para armazenar backups diferenciais.",
            "usados exclusivamente em redes sem Internet.",
            "necessários para instalar impressoras locais."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            "características físicas ou comportamentais do indivíduo.",
            "endereços de sites salvos como favoritos.",
            "números de portas TCP de servidores.",
            "cópias completas de pastas compartilhadas.",
            "formatos compactados como ZIP e RAR."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            "a quantidade de caracteres obrigatórios em uma senha.",
            "o tempo máximo aceitável para restaurar um serviço após incidente.",
            "o endereço físico gravado na placa de rede.",
            "o protocolo usado para envio de e-mail.",
            "a taxa de compactação de um arquivo ZIP."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            "um tipo de cabo utilizado em redes locais.",
            "um protocolo de envio de mensagens de e-mail.",
            "um padrão mais moderno de proteção para redes Wi-Fi.",
            "um formato de arquivo compactado.",
            "um método para aumentar a memória RAM."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            "um antivírus atualiza assinaturas em segundo plano.",
            "um backup incremental copia alterações recentes.",
            "um usuário altera senha após expiração.",
            "um firewall bloqueia tráfego por regra.",
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "melhorar a integridade dos arquivos armazenados.",
            "confirmar autoria de documentos assinados.",
            "organizar favoritos no navegador.",
            "reduzir o tamanho de arquivos de imagem."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            "permissão total para todos por padrão.",
            "senhas escritas no nome do arquivo.",
            "desativação de logs para reduzir ruído.",
            "necessidade de acesso por usuário, grupo e finalidade do dado.",
            "compartilhamento irrestrito em pastas públicas."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            "garantir que nenhum evento seja registrado.",
            "conceder acesso administrativo a todos.",
            "restaurar ou reduzir danos após uma falha ou incidente.",
            "impedir qualquer atualização de segurança.",
            "aumentar apenas a estética da interface."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            "procurar vulnerabilidades em protocolos de roteamento.",
            "usar cabo óptico para transmissão de longa distância.",
            "configurar tema visual em apresentação corporativa.",
            "restaurar arquivos pela lixeira do sistema.",
    ...
    },
    {
        ...
        "alternativas": [
            "configurados apenas para impressão local autorizada.",
            "comprometidos e controlados remotamente para ações coordenadas.",
            "usados exclusivamente como backup offline.",
            "protegidos por criptografia de disco validada.",
            "conectados por cabo HDMI a um monitor."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "editar textos colaborativos com controle de alterações.",
            "compactar arquivos de imagem em alta resolução.",
            "criar apresentações com animações automáticas.",
            "formatar planilhas com fórmulas financeiras."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            "executar o arquivo imediatamente para confirmar o conteúdo.",
            "desativar o antivírus para evitar bloqueios indevidos.",
            "encaminhar o anexo para todos os contatos.",
            "informar senha pessoal ao remetente para validação.",
    ...
    },
    {
        ...
        "alternativas": [
            "perda de velocidade da conexão cabeada.",
            "incompatibilidade de cabos HDMI com monitores.",
            "ausência de fórmulas em planilhas eletrônicas.",
            "exposição de documentos, anotações e mídias sensíveis no ambiente.",
            "fragmentação lógica em unidades de estado sólido."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            "senha forte, antivírus atualizado e arquivo compactado.",
            "backup completo, mídia externa e rotina de teste.",
            "monitor, teclado e mouse utilizados pelo usuário.",
            "download, upload e streaming em navegador.",
    ...
    },
    {
        ...
        "alternativas": [
            "editar apresentações diretamente no roteador.",
            "converter cabos coaxiais em fibra óptica.",
            "gerenciar configurações, políticas e segurança de aparelhos.",
            "aumentar a capacidade física da bateria.",
            "substituir contratos de confidencialidade."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            "instalar aplicativos sem validação para ampliar recursos.",
            "liberar portas de rede por padrão para todos os usuários.",
            "armazenar credenciais administrativas em documentos locais.",
            "desabilitar logs para melhorar o desempenho.",
    ...
    },
    {
        ...
        "alternativas": [
            "tamanho físico do monitor conectado.",
            "comportamentos ou características suspeitas, mesmo sem assinatura exata.",
            "ordem alfabética dos nomes de arquivos.",
            "velocidade nominal da fonte de alimentação.",
            "quantidade de slides em uma apresentação."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            "todos os arquivos selecionados a cada execução.",
            "somente alterações desde o último backup completo.",
            "apenas arquivos enviados por correio eletrônico.",
            "apenas alterações ocorridas desde o último backup de qualquer tipo.",
            "exclusivamente dados armazenados em nuvem pública."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            "aumento indevido da resolução do monitor.",
            "remoção de cabeçalhos em documentos.",
            "conversão automática de arquivos PDF.",
            "perda de desempenho por excesso de fibra óptica.",
    ...
    },
    {
        ...
        "alternativas": [
            "toda rede interna é sempre segura por definição.",
            "usuários autenticados nunca precisam de autorização.",
            "senhas compartilhadas aumentam produtividade segura.",
            "nenhum acesso deve ser confiado automaticamente sem verificação contínua.",
            "dispositivos pessoais devem ser liberados sem controle."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            "HTTPS impede totalmente qualquer golpe online.",
            "sites fraudulentos também podem usar conexão criptografada.",
            "certificados digitais eliminam engenharia social.",
            "o cadeado substitui análise do domínio visitado.",
            "navegadores bloqueiam todos os anexos perigosos."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            "livre circulação para agilizar manutenção informal.",
            "entrada autorizada, registro de acesso e proteção do ambiente.",
            "senhas compartilhadas em quadro visível.",
            "portas abertas para melhorar ventilação.",
            "remoção de câmeras para preservar espaço em disco."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            "à tela física usada para exibir alertas do antivírus.",
            "ao espaço livre existente em uma partição de disco.",
            "ao número de slides em uma apresentação corporativa.",
            "à velocidade nominal de um processador gráfico.",
    ...
    },
    {
        ...
        "alternativas": [
            "fontes de alimentação contra variação elétrica.",
            "teclados contra desgaste físico das teclas.",
            "arquivos ZIP contra perda de compactação.",
            "planilhas contra erros de arredondamento.",
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "permitir que senhas sejam armazenadas em texto claro.",
            "reduzir a necessidade de autenticação do usuário.",
            "substituir completamente políticas de troca de senha.",
            "compactar automaticamente credenciais antigas."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            "apenas a cor dos alertas exibidos ao usuário final.",
            "somente o modelo de mouse usado pela equipe técnica.",
            "papéis, procedimentos, comunicação e etapas de tratamento do incidente.",
            "a lista de músicas permitidas durante expediente.",
            "a ordem de slides em treinamentos de apresentação."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            "aumenta a frequência do processador automaticamente.",
            "dispensa planejamento de continuidade de negócios.",
            "impede que usuários esqueçam suas senhas.",
            "confirma se os dados copiados podem ser recuperados quando necessário.",
            "substitui filtros de conteúdo na navegação."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "substituir o uso de permissões por grupos.",
            "dispensar qualquer registro de auditoria.",
            "compactar credenciais automaticamente."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            "aumento automático de desempenho dos computadores.",
            "substituição de firewall por antivírus doméstico.",
            "uso de senhas iguais entre todos os setores.",
            "aderência a leis, normas, políticas e requisitos aplicáveis.",
            "armazenamento ilimitado de dados sem finalidade."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            "uma ameaça real é ignorada pelo sistema.",
            "um backup completo é restaurado com sucesso.",
            "uma senha expirada é trocada corretamente.",
            "um certificado válido é reconhecido pelo navegador.",
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "permissões administrativas para agilizar tarefas rotineiras.",
            "acesso completo aos dados para evitar chamados técnicos.",
            "a mesma senha institucional utilizada pela equipe.",
            "privilégios permanentes mesmo após mudança de função."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "foi corrigida há muitos anos por atualização oficial.",
            "só ocorre em arquivos de imagem sem conexão à rede.",
            "depende exclusivamente de erro de digitação em planilhas.",
            "não pode afetar sistemas conectados à Internet."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            "eliminar o uso de autenticação em sistemas internos.",
            "evitar que uma mesma pessoa concentre etapas críticas de um processo.",
            "tornar todos os usuários administradores locais.",
            "substituir registros de auditoria por permissões gerais.",
            "garantir que senhas sejam compartilhadas entre setores."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            "aumentar a resolução dos arquivos de imagem.",
            "impedir associação direta ou indireta razoável a uma pessoa identificável.",
            "permitir identificação mais rápida do titular.",
            "criar senhas iguais para todos os usuários.",
            "substituir backup por sincronização simples."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            "envia pacotes ICMP para testar conectividade.",
            "observa informações digitadas ou exibidas por cima do ombro da vítima.",
            "aplica atualização oficial do sistema operacional.",
            "gera cópia diferencial dos arquivos críticos.",
            "assina digitalmente documento corporativo."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "nega a existência de qualquer ameaça ao sistema.",
            "remove todos os controles sem avaliação formal.",
            "transfere automaticamente senhas para terceiros.",
            "garante impossibilidade absoluta de incidentes."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "permite alterar logs para simplificar relatórios.",
            "dispensa o registro de horários e responsáveis.",
            "garante aumento imediato da velocidade da rede.",
            "substitui todos os controles preventivos."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            "aumentar o brilho do monitor durante análises.",
            "compactar arquivos sem perda de qualidade.",
            "transformar planilhas em apresentações.",
            "substituir a necessidade de logs.",
