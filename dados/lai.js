...

{
    ...
    feedbackErro:
    `Revise o fundamento da questão. A alternativa correta preserva legalidade, finalidade pública, ética, transparência adequada e responsabilidade funcional.`,

    dicaBanca:
    `Não confunda identificação do requerente com justificativa do interesse.`
},

{
    pergunta:
    `Documento solicitado contém parte pública e parte protegida por dado pessoal. A solução correta é:`,
    ...
    dicaBanca:
    `Dados pessoais não tornam tudo automaticamente sigiloso.`
},

{
    pergunta:
    `A negativa de acesso a informação pública deve ser:`,
    ...
    dicaBanca:
    `Negativa sem motivação é ponto clássico de erro.`
},

{
    ...
    dicaBanca:
    `Ativa = o órgão publica antes de ser provocado.`
},
...
{
    pergunta:
    `Considerando uma ocorrência durante orientação a usuário do serviço, um cidadão solicita informação sobre contrato administrativo e o órgão exige justificativa do pedido. Pela LAI, a exigência é:`,
...
{
    pergunta:
    `Considerando uma ocorrência ao analisar processo administrativo, a transparência ativa ocorre quando o órgão:`,
...
{
    pergunta:
    `Considerando uma ocorrência ao organizar documentos do setor, a negativa de acesso a informação pública deve ser:`,
...
{
    pergunta:
    `Considerando uma ocorrência durante triagem de solicitações, a transparência ativa ocorre quando o órgão:`,
...
{
    pergunta:
    `Considerando uma ocorrência ao analisar processo administrativo, documento solicitado contém parte pública e parte protegida por dado pessoal. A solução correta é:`,
