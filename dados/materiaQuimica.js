...

{
    ...
    feedbackErro:
    `Revise o conceito central. A alternativa correta é a que respeita o critério químico usado para classificar o fenômeno.`,

    dicaBanca:
    `Não confunda matéria com aquilo que é apenas visível ou sólido.`
},

{
    ...
    dicaBanca:
    `Questões desse tipo cobram o critério: porção, finalidade e composição.`
},

{
    pergunta:
    `Um estudante afirmou que massa e peso são grandezas equivalentes. A correção conceitual mais adequada é:`,

    alternativas: [
        `Massa é quantidade de matéria; peso é força relacionada à ação gravitacional sobre essa massa.`,
        `Massa é força gravitacional; peso é a quantidade de matéria presente em um corpo.`,
        `Massa depende apenas do local; peso permanece invariável em qualquer planeta.`,
        `Massa e peso são idênticos, pois ambos são medidos obrigatoriamente em quilogramas.`,
        `Peso é propriedade química; massa é propriedade organoléptica percebida pelos sentidos.`,
    ],

    correta: 0,

    explicacao:
    `Massa não depende da gravidade local; peso depende da gravidade.`,
    ...
    dicaBanca:
    `Massa e peso costumam aparecer como pegadinha em propriedades da matéria.`
},

{
    ...
    dicaBanca:
    `Quando aparecer seringa, pneu ou cilindro de ar, pense em compressibilidade dos gases.`
},

{
    ...
    dicaBanca:
    `Propriedade específica ajuda a identificar materiais; propriedade geral não identifica.`
},

{
    ...
    dicaBanca:
    `Flutuação não depende apenas da massa, mas da relação massa/volume.`
},

{
    ...
    dicaBanca:
    `Navio de aço é exemplo clássico de densidade média.`
},

{
    ...
    dicaBanca:
    `Forma e volume são critérios muito cobrados para estados físicos.`
},

{
    pergunta:
    `A vaporização pode ocorrer por evaporação, ebulição ou calefação. A alternativa correta é:`,

    alternativas: [
        `Evaporação é lenta e superficial; ebulição ocorre em toda a massa líquida; calefação ocorre rapidamente em superfície muito quente.`,
        `Evaporação e ebulição são sinônimos, pois ambas ocorrem sempre na mesma temperatura fixa.`,
        `Calefação é a passagem direta do sólido para o gasoso em qualquer condição de pressão.`,
        `Ebulição ocorre apenas na superfície do líquido, enquanto evaporação ocorre em toda a massa.`,
        `Vaporização é sempre transformação química, pois forma substância gasosa diferente.`,
    ],

    correta: 0,

    explicacao:
    `Vaporização é mudança física do líquido para o gasoso, mas pode ocorrer de modos diferentes.`,
    ...
    dicaBanca:
    `Roupa secando é evaporação; água fervendo é ebulição; gota em chapa quente é calefação.`
},

{
    ...
    dicaBanca:
    `Fusão, solidificação e vaporização não indicam reação química por si só.`
},

{
    ...
    dicaBanca:
    `Não confunda molécula de substância composta com mistura.`
},

{
    ...
    dicaBanca:
    `Substância simples pode ter molécula com mais de um átomo.`
},

{
    pergunta:
    `Uma mistura de água e sal totalmente dissolvido apresenta:`,

    alternativas: [
        `Dois componentes e uma única fase, sendo classificada como mistura homogênea.`,
        `Um componente e duas fases, sendo classificada como substância composta.`,
        `Duas fases e dois componentes, sendo classificada como mistura heterogênea.`,
        `Uma fase e um componente, pois o sal desaparece quimicamente na água.`,
        `Três fases e uma substância simples, pois há água, sal e solução.`,
    ],

    correta: 0,

    explicacao:
    `Água e sal são componentes; como há aspecto uniforme, existe uma fase.`,
    ...
    dicaBanca:
    `Fase não é a mesma coisa que componente.`
},

{
    ...
    dicaBanca:
    `Mistura heterogênea é definida pelo número de fases, não pelo estado físico.`
},

{
    ...
    dicaBanca:
    `Misturas sólidas também podem ser heterogêneas.`
},

{
    ...
    dicaBanca:
    `Areia em água lembra filtração ou decantação; o filtro retém o sólido.`
},

{
    pergunta:
    `A decantação é adequada para separar:`,

    alternativas: [
        `Componentes de uma mistura heterogênea com diferença de densidade entre as fases.`,
        `Elementos químicos de uma substância composta por quebra do núcleo atômico.`,
        `Líquidos miscíveis com pontos de ebulição muito próximos.`,
        `Soluto dissolvido em solução homogênea sem diferença de fases.`,
        `Partículas subatômicas de um átomo neutro por ação de peneira.`,
    ],

    correta: 0,

    explicacao:
    `Decantação separa fases por diferença de densidade, como água e óleo ou sólido sedimentado em líquido.`,
    ...
    dicaBanca:
    `Quando houver fases e densidades diferentes, considere decantação.`
},

{
    ...
    dicaBanca:
    `Água e sal: evaporação recupera sal; destilação recupera água.`
},

{
    ...
    dicaBanca:
    `Frações do petróleo são exemplo recorrente de destilação fracionada.`
},

{
    ...
    dicaBanca:
    `Cromatografia costuma aparecer em separação de pigmentos.`
},

{
    ...
    dicaBanca:
    `Derreter, quebrar e evaporar geralmente indicam mudança física.`
},

{
    ...
    dicaBanca:
    `Formação de nova substância é o critério principal.`
},

{
    ...
    dicaBanca:
    `Nem todo sinal visual prova reação isoladamente; procure formação de nova substância.`
},

{
    pergunta:
    `Quando uma palha de aço enferruja em ambiente úmido, ocorre:`,

    alternativas: [
        `Transformação química, com formação de novas substâncias por oxidação do ferro.`,
        `Transformação física, pois o ferro muda apenas de posição no espaço.`,
        `Mudança de estado físico, pois o metal passa de sólido para gasoso.`,
        `Separação de mistura, pois a umidade retira o ferro puro do material.`,
        `Neutralização obrigatória, pois todo metal úmido reage com uma base forte.`,
    ],

    correta: 0,

    explicacao:
    `A ferrugem resulta de reação química envolvendo ferro, oxigênio e umidade.`,
    ...
    dicaBanca:
    `Ferrugem é exemplo clássico de oxidação.`
},

{
    ...
    dicaBanca:
    `Queima, combustão e formação de gases indicam reação química.`
},

{
    pergunta:
    `Em uma equação química, os reagentes e produtos são representados, respectivamente:`,

    alternativas: [
        `Antes e depois da seta, indicando substâncias consumidas e formadas.`,
        `Depois e antes da seta, indicando substâncias formadas e consumidas.`,
        `Abaixo e acima da seta, indicando apenas as massas das substâncias.`,
        `Somente por números, sem necessidade de fórmulas químicas.`,
        `Por cores e estados físicos, sem relação com composição.`,
    ],

    correta: 0,

    explicacao:
    `Reagentes ficam à esquerda da seta; produtos, à direita.`,
    ...
    dicaBanca:
    `Leia a seta como 'reagem formando'.`
},

{
    ...
    dicaBanca:
    `Não mude fórmula para balancear.`
},

{
    ...
    dicaBanca:
    `Conservação da massa exige sistema fechado.`
},
...

{
    ...
    dicaBanca:
    `Thomson = elétrons inseridos em massa positiva.`
},

{
    ...
    dicaBanca:
    `Rutherford = núcleo e espaço vazio.`
},

{
    pergunta:
    `O modelo de Bohr acrescentou ao modelo nuclear a ideia de:`,

    alternativas: [
        `Elétrons distribuídos em níveis de energia definidos.`,
        `Átomo completamente indivisível e sem cargas elétricas.`,
        `Elétrons incrustados em uma esfera positiva uniforme.`,
        `Núcleo inexistente e massa distribuída por todo o átomo.`,
        `Prótons circulando fora do átomo em orbitais indefinidos.`,
    ],

    correta: 0,

    explicacao:
    `Bohr propôs níveis de energia para os elétrons.`,
    ...
    dicaBanca:
    `Bohr = camadas ou níveis de energia.`
},

{
    ...
    dicaBanca:
    `Modelo atual não trabalha com órbitas rígidas como trajetórias planetárias.`
},

{
    ...
    dicaBanca:
    `Próton positivo, elétron negativo, nêutron neutro.`
},

{
    ...
    dicaBanca:
    `Z = prótons; A = prótons + nêutrons.`
},

{
    pergunta:
    `Um cátion é formado quando um átomo:`,

    alternativas: [
        `Perde elétrons e fica com carga positiva.`,
        `Ganha elétrons e fica com carga negativa.`,
        `Ganha prótons e mantém o mesmo número atômico.`,
        `Perde nêutrons e torna-se eletricamente neutro.`,
        `Divide o núcleo e forma duas substâncias simples.`,
    ],

    correta: 0,

    explicacao:
    `Cátions são íons positivos formados por perda de elétrons.`,
...

{
    ...
    dicaBanca:
    `Elemento químico é definido por Z, o número de prótons.`
},
...

{
    ...
    dicaBanca:
    `Iônica = transferência; covalente = compartilhamento.`
},
...

{
    ...
    dicaBanca:
    `Metálica = elétrons livres ou deslocalizados.`
},

{
    ...
    dicaBanca:
    `pH menor que 7 indica meio ácido.`
},

{
    pergunta:
    `Uma característica comum das bases em abordagem básica é:`,

    alternativas: [
        `Apresentarem pH maior que 7 em soluções aquosas usuais.`,
        `Apresentarem sempre pH menor que 7 e liberarem apenas gás oxigênio.`,
        `Serem obrigatoriamente formadas apenas por carbono e hidrogênio.`,
        `Não interagirem com ácidos em reações de neutralização.`,
        `Serem sempre gasosas e insolúveis em qualquer solvente.`,
    ],

    correta: 0,

    explicacao:
    `Bases geralmente apresentam pH maior que 7 em soluções aquosas.`,
...

{
    ...
    dicaBanca:
    `pH 7 = neutro; menor = ácido; maior = básico.`
},
...

{
    ...
    dicaBanca:
    `Óxido lembra oxigênio + outro elemento.`
},

{
    ...
    dicaBanca:
    `Sal em função química não significa apenas sal de cozinha.`
},

{
    ...
    dicaBanca:
    `Síntese = união ou combinação.`
},

{
    pergunta:
    `Uma reação de decomposição é aquela em que:`,

    alternativas: [
        `Uma substância origina duas ou mais substâncias.`,
        `Duas substâncias formam apenas um produto.`,
        `Um metal desloca outro em uma solução.`,
        `Dois sais trocam íons sem alteração de composição.`,
        `Um líquido evapora sem formar nova substância.`,
    ],

    correta: 0,

    explicacao:
    `Decomposição envolve quebra de uma substância em produtos mais simples.`,
...

{
    ...
    dicaBanca:
    `Simples troca envolve deslocamento.`
},

{
    ...
    dicaBanca:
    `Dupla troca = troca entre compostos.`
},

{
    pergunta:
    `Na representação 2H₂ + O₂ → 2H₂O, o coeficiente 2 antes de H₂ indica:`,

    alternativas: [
        `Duas moléculas de gás hidrogênio participando da proporção representada.`,
        `Dois átomos de oxigênio dentro da molécula de hidrogênio.`,
        `Dois prótons adicionados ao núcleo do hidrogênio.`,
        `Duas fases visíveis formadas antes da reação.`,
        `Duas substâncias compostas com hidrogênio e oxigênio.`,
    ],

    correta: 0,

    explicacao:
    `Coeficientes indicam proporções de moléculas ou mols na equação.`,
    ...
    dicaBanca:
    `Coeficiente fica antes da fórmula; índice fica dentro da fórmula.`
},

{
    ...
    dicaBanca:
    `Índice altera composição da substância; coeficiente altera proporção.`
},

{
    ...
    dicaBanca:
    `Lembre da conservação da massa: reagentes = produtos em sistema fechado.`
},

{
    pergunta:
    `A corrosão de metais em estruturas expostas ao ambiente é relevante porque:`,

    alternativas: [
        `Envolve transformação química que pode comprometer propriedades e segurança dos materiais.`,
        `É apenas mudança de estado físico reversível por resfriamento.`,
        `É separação de misturas por diferença de solubilidade.`,
        `É formação de ligações metálicas novas sem alteração química.`,
        `É processo que sempre aumenta a resistência do material.`,
    ],

    correta: 0,

    explicacao:
    `Corrosão envolve reações químicas, como oxidação, que alteram o material.`,
    ...
    dicaBanca:
    `Corrosão é transformação química com impacto cotidiano.`
},

{
    ...
    dicaBanca:
    `Tratamento de água é aplicação cotidiana de Química e separação de misturas.`
},

{
    ...
    dicaBanca:
    `Reciclagem relaciona propriedades dos materiais e separação.`
},

{
    ...
    dicaBanca:
    `Propriedades organolépticas não justificam provar ou cheirar substâncias desconhecidas.`
},
