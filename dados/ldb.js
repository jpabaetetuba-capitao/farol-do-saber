...
feedbackErro: "A educação, segundo a LDB, não se restringe à escola. O conceito legal abrange diversos contextos sociais e culturais.",

dicaBanca: "Educação é mais ampla que educação escolar."
},
...
feedbackErro: "As bancas costumam apresentar apenas parte da finalidade da educação. A redação legal exige os três elementos simultaneamente.",

dicaBanca: "Desenvolvimento + cidadania + trabalho."
},
...
feedbackErro: "A LDB não trata apenas do acesso à escola, mas também da permanência do estudante em condições adequadas.",

dicaBanca: "Acesso + permanência = princípio clássico da LDB."
},
...
feedbackErro: "Muitas questões utilizam faixas etárias antigas para induzir o erro do candidato.",

dicaBanca: "4 a 17 anos = dado obrigatório."
},

{
pergunta: "Uma família teve negada a matrícula de seu filho em idade de escolaridade obrigatória e decidiu buscar providências junto ao Poder Judiciário. Essa possibilidade encontra fundamento na LDB porque o acesso à educação básica obrigatória é considerado:",

alternativas: [
"Direito social assegurado mediante políticas públicas definidas pelos sistemas de ensino.",
"Direito fundamental garantido pela legislação educacional e pelas normas constitucionais vigentes.",
"Direito público subjetivo, podendo ser exigido judicialmente pelo cidadão.",
"Direito individual relacionado à oferta regular dos serviços educacionais prestados pelo Estado.",
"Direito educacional condicionado à disponibilidade de vagas nos sistemas públicos de ensino."
],
...
feedbackErro: "Direito público subjetivo significa que o cidadão pode exigir diretamente do Estado a garantia desse direito.",

dicaBanca: "Direito público subjetivo = exigível judicialmente."
},
...
feedbackErro: "O regime de colaboração é um dos fundamentos da organização educacional brasileira e aparece frequentemente em concursos.",

dicaBanca: "Regime de colaboração = União + Estados + DF + Municípios."
},
...
feedbackErro: "A Educação Infantil, o Ensino Fundamental e o Ensino Médio são etapas da Educação Básica, não níveis autônomos.",

dicaBanca: "Níveis = Educação Básica + Educação Superior."
},
...
feedbackErro: "A Educação Profissional pode articular-se à Educação Básica, mas não integra sua composição estrutural.",

dicaBanca: "Educação Básica = Infantil + Fundamental + Médio."
},
...
feedbackErro: "A União não administra diretamente todas as escolas nem elabora os currículos locais.",

dicaBanca: "União = coordenação nacional + função normativa."
},
...
feedbackErro: "As demais alternativas referem-se a atribuições da União ou dos Municípios.",

dicaBanca: "Estado = sistema estadual de ensino."
},
{
...
feedbackErro: "A banca costuma retirar uma das etapas ou atribuir ao Município responsabilidades prioritárias que pertencem a outros entes federativos.",

dicaBanca: "Município = Educação Infantil + Ensino Fundamental."
},
...
feedbackErro: "O sistema de ensino do Distrito Federal possui características próprias previstas na legislação educacional.",

dicaBanca: "DF = competências de Estado + Município."
},
...
feedbackErro: "A garantia desse direito não depende apenas da disponibilidade de vagas ou de decisões administrativas.",

dicaBanca: "Direito público subjetivo = exigível judicialmente."
},

{
pergunta: "Durante uma fiscalização educacional, verificou-se que determinada localidade não ofertava regularmente o ensino obrigatório aos estudantes em idade escolar. Segundo a LDB, essa situação implica:",

alternativas: [
"A necessidade de intervenção administrativa imediata da União sobre o sistema de ensino responsável.",
"Responsabilidade da autoridade competente pelo não oferecimento ou pela oferta irregular do ensino obrigatório.",
"Suspensão temporária da autorização de funcionamento das instituições responsáveis pela oferta educacional.",
"Obrigação de transferência dos estudantes para sistemas de ensino mantidos por outros entes federativos.",
"Aplicação automática de sanções financeiras ao sistema educacional responsável pela irregularidade."
],

correta: 1,

feedbackAcerto: "Correto. A LDB prevê responsabilidade da autoridade competente pelo não oferecimento ou oferta irregular do ensino obrigatório.",

feedbackErro: "Trata-se de um dispositivo frequentemente cobrado em sua redação literal.",

dicaBanca: "Oferta irregular = responsabilidade da autoridade."
},

{
pergunta: "Ao discutir políticas de educação inclusiva, uma equipe escolar analisava a garantia do atendimento educacional especializado prevista na LDB. Nessa perspectiva, é correto afirmar que esse atendimento deve ser ofertado:",

alternativas: [
"Preferencialmente na rede regular de ensino, assegurando condições adequadas para a participação e aprendizagem dos estudantes.",
"Em instituições especializadas responsáveis pelo desenvolvimento das competências necessárias à inclusão escolar.",
"Nos sistemas de ensino que disponham de estrutura específica para atendimento dos estudantes público-alvo da educação especial.",
"Em espaços pedagógicos próprios, articulados às instituições regulares sempre que houver necessidade comprovada.",
"Por meio de serviços educacionais específicos organizados segundo as características individuais dos estudantes atendidos."
],

correta: 0,

feedbackAcerto: "Correto. A LDB determina que o atendimento educacional especializado seja oferecido preferencialmente na rede regular de ensino.",

feedbackErro: "A legislação privilegia a inclusão e a participação dos estudantes nos ambientes regulares de aprendizagem.",

dicaBanca: "AEE = preferencialmente na rede regular."
},
{
...
feedbackErro: "A gestão democrática vai além da simples consulta ou comunicação das decisões já tomadas.",

dicaBanca: "Gestão democrática = participação real."
},
...
feedbackErro: "O PPP é construído pela própria instituição e não se limita a aspectos administrativos.",

dicaBanca: "PPP = identidade + planejamento da escola."
},

{
pergunta: "Ao analisar os princípios da gestão democrática previstos na LDB, uma professora destacou a importância da participação dos profissionais da educação na elaboração do projeto pedagógico. Essa participação tem como finalidade principal:",

alternativas: [
"Fortalecer o compromisso coletivo com as decisões pedagógicas e com os objetivos educacionais da instituição.",
"Distribuir responsabilidades administrativas entre os profissionais responsáveis pela execução das atividades escolares.",
"Ampliar a autonomia docente na definição dos conteúdos e metodologias adotados em cada componente curricular.",
"Favorecer a descentralização das funções de gestão por meio da atuação colaborativa dos professores.",
"Promover o alinhamento das práticas pedagógicas às diretrizes definidas pelos sistemas de ensino."
],

correta: 0,

feedbackAcerto: "Correto. A participação fortalece o compromisso coletivo e a corresponsabilidade pelas ações da escola.",

feedbackErro: "A participação docente no PPP não tem caráter meramente administrativo ou burocrático.",

dicaBanca: "Participação = corresponsabilidade."
},

{
pergunta: "Em uma escola pública, o Conselho Escolar foi consultado sobre prioridades de investimento, organização de projetos e melhoria das condições de ensino. Essa atuação relaciona-se diretamente ao princípio da:",

alternativas: [
"Autonomia pedagógica das instituições de ensino na condução de suas atividades curriculares.",
"Gestão democrática do ensino público por meio da participação da comunidade escolar.",
"Descentralização administrativa dos recursos destinados às instituições educacionais.",
"Planejamento participativo voltado à melhoria dos indicadores de aprendizagem dos estudantes.",
"Organização colegiada dos sistemas de ensino responsáveis pela administração das escolas públicas."
],

correta: 1,

feedbackAcerto: "Correto. Os conselhos escolares são instrumentos importantes de participação e gestão democrática.",

feedbackErro: "A atuação dos conselhos está diretamente associada à participação da comunidade escolar na gestão da instituição.",

dicaBanca: "Conselho Escolar = gestão democrática."
},
...
feedbackErro: "A elaboração e execução da proposta pedagógica constituem responsabilidades diretas da instituição de ensino.",

dicaBanca: "Escola = elaborar e executar sua proposta pedagógica."
},
{
...
feedbackErro: "A questão exige conhecimento das incumbências dos docentes previstas no art. 13 da LDB.",

dicaBanca: "Art. 13 = proposta pedagógica + plano de trabalho."
},
...
feedbackErro: "A recuperação da aprendizagem é responsabilidade direta do professor e constitui dispositivo expresso da LDB.",

dicaBanca: "Aprendizagem + recuperação = dever docente."
},
...
feedbackErro: "Trata-se de uma incumbência prevista expressamente no art. 13 da LDB.",

dicaBanca: "Planejamento + avaliação + formação = obrigação docente."
},
...
feedbackErro: "Embora existam exceções previstas em lei, a regra geral é a licenciatura plena.",

dicaBanca: "Regra geral = licenciatura plena."
},
...
feedbackErro: "A LDB trata a valorização profissional como elemento essencial para a qualidade da educação.",

dicaBanca: "Valorização = formação + carreira + condições de trabalho."
},
{
...
feedbackAcerto: "Correto. A LDB define como finalidade da Educação Infantil o desenvolvimento integral da criança em seus diversos aspectos.",

feedbackErro: "A Educação Infantil não se destina apenas à preparação para o Ensino Fundamental ou à alfabetização precoce.",

dicaBanca: "Educação Infantil = desenvolvimento integral."
},

{
pergunta: "Ao analisar a organização da Educação Infantil, uma equipe gestora discutia as diferenças entre creche e pré-escola. De acordo com a LDB, a creche destina-se ao atendimento de crianças:",

alternativas: [
"De zero a três anos de idade, em instituições educacionais organizadas para essa finalidade.",
"De zero a quatro anos de idade, em instituições responsáveis pelo desenvolvimento integral da infância.",
"De até três anos de idade, priorizando experiências relacionadas ao cuidado e à socialização.",
"De até quatro anos incompletos, em ambientes educacionais articulados à Educação Básica.",
"De zero a três anos de idade, observadas as orientações curriculares previstas para a Educação Infantil."
],

correta: 0,

feedbackAcerto: "Correto. A LDB estabelece que a creche atende crianças de até três anos de idade.",

feedbackErro: "A principal pegadinha costuma ocorrer na diferenciação entre creche e pré-escola.",

dicaBanca: "Creche = até 3 anos."
},
...
feedbackErro: "A Educação Infantil possui finalidade própria e não deve ser reduzida à preparação para etapas posteriores.",

dicaBanca: "Pré-escola = 4 e 5 anos."
},
...
feedbackErro: "A LDB afasta qualquer lógica classificatória ou promocional nessa etapa.",

dicaBanca: "Educação Infantil = avaliação sem promoção."
},
...
feedbackErro: "A Educação Infantil possui identidade própria e não deve ser compreendida apenas como preparação para etapas posteriores.",

dicaBanca: "Família + comunidade + desenvolvimento integral."
},
{
...
feedbackErro: "Uma pegadinha frequente é utilizar a antiga duração de oito anos ou alterar a idade de ingresso.",

dicaBanca: "Ensino Fundamental = 9 anos + início aos 6 anos."
},
...
feedbackErro: "A banca costuma apresentar finalidades legítimas da educação, mas a resposta correta exige a redação específica da LDB.",

dicaBanca: "Ensino Fundamental = formação básica do cidadão."
},

{
pergunta: "Durante uma formação pedagógica, discutia-se o desenvolvimento da capacidade de aprender como um dos objetivos do Ensino Fundamental. De acordo com a LDB, essa capacidade está relacionada principalmente:",

alternativas: [
"À consolidação de conhecimentos acadêmicos indispensáveis para a continuidade dos estudos.",
"À aquisição de habilidades cognitivas necessárias ao desempenho escolar e social dos estudantes.",
"Ao pleno domínio da leitura, da escrita e do cálculo como instrumentos básicos da aprendizagem.",
"À construção de competências voltadas à compreensão crítica dos fenômenos sociais contemporâneos.",
"À ampliação progressiva das experiências educativas associadas às áreas do conhecimento."
],

correta: 2,

feedbackAcerto: "Correto. A LDB destaca o pleno domínio da leitura, da escrita e do cálculo como instrumentos básicos da aprendizagem.",

feedbackErro: "Esse é um dos objetivos mais cobrados do Ensino Fundamental em concursos.",

dicaBanca: "Leitura + escrita + cálculo = base do Ensino Fundamental."
},
...
feedbackErro: "A questão exige atenção aos elementos expressamente mencionados pela legislação.",

dicaBanca: "Ambiente natural + social + sistema político + tecnologia + artes + valores."
},
...
feedbackErro: "Dias letivos e carga horária mínima são temas muito cobrados em concursos e costumam aparecer com pequenas alterações na redação.",

dicaBanca: "200 dias letivos = dado clássico da LDB."
},
{
...
feedbackErro: "A LDB não reduz o Ensino Médio à preparação profissional ou ao acesso ao Ensino Superior.",

dicaBanca: "Ensino Médio = consolidar e aprofundar conhecimentos."
},
...
feedbackErro: "A preparação para o trabalho não significa formação profissional obrigatória.",

dicaBanca: "Preparação básica para o trabalho ≠ profissionalização obrigatória."
},

{
pergunta: "Durante uma formação continuada, discutia-se a formação ética dos estudantes do Ensino Médio. Segundo a LDB, essa etapa deve contribuir para:",

alternativas: [
"O fortalecimento dos vínculos sociais e a compreensão dos direitos e deveres necessários ao exercício da cidadania.",
"A formação integral do estudante por meio do desenvolvimento da autonomia intelectual e do pensamento crítico.",
"A construção de valores associados à participação democrática e à convivência em sociedade.",
"O aprimoramento das capacidades cognitivas necessárias à compreensão dos fundamentos científico-tecnológicos dos processos produtivos.",
"A ampliação das experiências formativas relacionadas ao desenvolvimento pessoal e social dos estudantes."
],

correta: 1,

feedbackAcerto: "Correto. A LDB destaca o aprimoramento do educando como pessoa humana, incluindo autonomia intelectual e pensamento crítico.",

feedbackErro: "Embora várias alternativas apresentem elementos relevantes, a autonomia intelectual e o pensamento crítico aparecem expressamente na LDB.",

dicaBanca: "Autonomia intelectual + pensamento crítico."
},
...
feedbackErro: "A questão exige atenção à redação específica da LDB.",

dicaBanca: "Teoria + prática = fundamento clássico do Ensino Médio."
},
...
feedbackErro: "As alternativas são próximas, mas a correta expressa de forma mais abrangente a finalidade dessa etapa segundo a LDB.",

dicaBanca: "Ensino Médio = última etapa da Educação Básica."
},
{
...
feedbackAcerto: "Correto. A Educação Especial é modalidade transversal ofertada preferencialmente na rede regular de ensino.",

feedbackErro: "A principal pegadinha é restringir a Educação Especial a instituições segregadas.",

dicaBanca: "Educação Especial = modalidade transversal + inclusão."
},
...
feedbackAcerto: "Correto. A EJA destina-se àqueles que não tiveram acesso ou continuidade de estudos na idade própria.",

feedbackErro: "A idade regular de escolarização é o critério central para caracterizar a EJA.",

dicaBanca: "EJA = acesso ou continuidade fora da idade própria."
},
...
feedbackErro: "A banca costuma trocar uma das três dimensões: trabalho, ciência e tecnologia.",

dicaBanca: "Educação Profissional = trabalho + ciência + tecnologia."
},
...
feedbackErro: "O foco da LDB está na adaptação da oferta educacional às características do campo.",

dicaBanca: "Educação do Campo = respeito às peculiaridades rurais."
},
...
feedbackErro: "A educação indígena não tem como finalidade a assimilação cultural, mas o respeito à identidade dos povos indígenas.",

dicaBanca: "Educação Indígena = língua, cultura e identidade."
},
{
...
feedbackErro: "A Educação Superior não se limita à formação profissional, abrangendo também pesquisa, produção cultural e reflexão crítica.",

dicaBanca: "Educação Superior = criação cultural + espírito científico."
},
...
feedbackErro: "Autonomia não significa independência absoluta em relação à legislação educacional.",

dicaBanca: "Autonomia universitária ≠ soberania."
},
...
feedbackErro: "A pesquisa não é atividade complementar; ela integra a finalidade da Educação Superior.",

dicaBanca: "Pesquisa = produção e difusão do conhecimento."
},
...
feedbackAcerto: "Correto. A extensão promove a interação transformadora entre universidade e sociedade.",

feedbackErro: "A extensão não é apenas aplicação prática do conhecimento, mas diálogo e troca com a comunidade.",

dicaBanca: "Extensão = universidade + sociedade."
},
