...
const internet = [
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "Ao fragmento interno da página.",
            "Ao protocolo de comunicação.",
            "Ao domínio principal do servidor.",
            "Ao certificado digital do site."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            "São arquivos executáveis instalados no sistema operacional.",
            "São mantidos apenas durante a sessão de navegação e removidos ao encerrá-la.",
            "São usados exclusivamente para transmitir vídeo ao vivo.",
            "Impedem qualquer rastreamento por sites.",
            "Funcionam apenas em redes sem fio públicas."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            "Armazenar apenas senhas digitadas em formulários.",
            "Substituir o DNS na tradução de domínios.",
            "Guardar recursos já carregados para acelerar acessos posteriores e reduzir tráfego.",
            "Criptografar automaticamente todas as páginas HTTP.",
            "Bloquear anexos de e-mail suspeitos."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            "Compactando arquivos antes do download.",
            "Criptografando todo tráfego HTTP do navegador.",
            "Substituindo a placa de rede do computador.",
            "Consultando outros servidores DNS para obter a resposta solicitada pelo cliente.",
            "Enviando mensagens por SMTP."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            "Como endereços obrigatórios de servidores DNS raiz.",
            "Apenas para páginas HTTPS com certificado válido.",
            "Para substituir nomes de domínio em URLs públicas.",
            "Como extensões de arquivos de configuração.",
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "À leitura sincronizada de mensagens mantendo-as no servidor.",
            "À tradução de nomes de domínio em endereços IP.",
            "À transferência de páginas web para navegadores.",
            "À criação de redes locais sem fio."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            "É usado apenas para transferir páginas HTML.",
            "Mantém as mensagens no servidor e sincroniza o estado entre dispositivos.",
            "Substitui o protocolo DNS em redes corporativas.",
            "Funciona exclusivamente sem conexão com a Internet.",
            "Impede o uso de anexos em e-mails."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            "O site está livre de golpes e jamais poderá conter malware.",
            "O navegador está em modo anônimo obrigatório.",
            "A conexão pode autenticar o domínio e usar criptografia, mas isso não garante que o conteúdo do site seja honesto.",
            "O computador do usuário não precisa de atualizações.",
            "O site pertence necessariamente ao governo."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            "Criar senhas temporárias para e-mails corporativos.",
            "Substituir o sistema operacional do servidor.",
            "Converter arquivos PDF em planilhas.",
            "Distribuir conteúdo por servidores geograficamente espalhados, melhorando desempenho e disponibilidade.",
            "Realizar autenticação biométrica em redes locais."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            "Remover automaticamente vírus dos dispositivos conectados.",
            "Garantir anonimato absoluto em qualquer site acessado.",
            "Substituir a necessidade de autenticação do usuário.",
            "Aumentar a capacidade física do roteador.",
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "Armazenar permanentemente todos os arquivos do sistema operacional.",
            "Converter qualquer página HTTP em aplicativo móvel.",
            "Substituir a placa de vídeo do computador.",
            "Executar exclusivamente apresentações do PowerPoint."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            "Compatibilidade apenas com cabos Ethernet.",
            "Maior velocidade potencial e menor alcance/penetração em obstáculos.",
            "Acesso sem necessidade de roteador.",
            "Impossibilidade de usar criptografia WPA.",
            "Funcionamento exclusivo para e-mail."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            "Pesquisar apenas imagens com alta resolução.",
            "Bloquear cookies de terceiros.",
            "Restringir resultados a um domínio ou site específico.",
            "Abrir a página em modo privado.",
            "Criar uma cópia offline do site."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            "Converter todos os resultados em PDF.",
            "Remover PDFs da lista de resultados.",
            "Pesquisar apenas dentro do computador local.",
    ...
    },
    {
        ...
        "alternativas": [
            "Somar dois critérios obrigatórios.",
            "Pesquisar apenas notícias recentes.",
            "Traduzir resultados automaticamente.",
            "Abrir links em nova guia.",
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "É sempre executável e instala programas automaticamente.",
            "Não pode conter endereços de sites.",
            "Funciona apenas em redes corporativas com firewall.",
            "Substitui a criptografia HTTPS."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            "Compactação de arquivos por perda.",
            ...
            "Tradução DNS reversa obrigatória.",
            "Criação de atalho no sistema operacional."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            "Funciona somente com cabos de rede Ethernet.",
            "Não permite anexos em nenhuma situação.",
            "É acessado por navegador, sem exigir instalação de um programa específico para a caixa postal.",
            "Dispensa qualquer senha ou autenticação.",
            "É o mesmo que protocolo DNS."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            "Dispensar o uso de servidor web.",
            "Bloquear qualquer uso de HTTPS.",
            "Ser usado apenas para baixar imagens.",
            "Enviar dados no corpo da requisição, em vez de expô-los diretamente na URL.",
            "Impedir validação de dados no servidor."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "É obrigatoriamente um aplicativo instalado.",
            "Não usa HTML ou CSS.",
            "Impede qualquer zoom do usuário.",
    ...
    },
    {
        ...
        "alternativas": [
            "Toda URI é uma URL, pois toda identificação informa obrigatoriamente o local de acesso.",
            "Toda URL é uma URI, pois além de identificar o recurso também informa como localizá-lo.",
            "URI e URL são nomes diferentes para domínio de Internet registrado em DNS.",
            "URL identifica apenas o servidor, enquanto URI identifica apenas o navegador.",
            "URI é usada somente em e-mails, enquanto URL é usada somente em páginas Web."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            "protocolo de transporte usado pelo navegador.",
            "porta lógica padrão do serviço de páginas.",
            "subdomínio associado ao domínio faroldosaber.com.br.",
            "extensão de país vinculada ao registro .br.",
            "caminho físico do arquivo dentro do servidor."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            "protocolos de navegação usados para criptografar páginas.",
            "pastas obrigatórias dentro do servidor de hospedagem.",
            "endereços IP públicos convertidos para formato textual.",
            "categorias de domínio relacionadas ao tipo de entidade ou finalidade do site.",
            "arquivos de configuração do navegador do usuário."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            "Registro armazena páginas Web; hospedagem apenas protege o navegador contra fraudes.",
            "Registro configura senhas de e-mail; hospedagem converte nomes em endereços MAC.",
            "Registro substitui o DNS; hospedagem substitui o protocolo HTTPS na navegação.",
            "Registro cria o navegador; hospedagem instala extensões no computador do usuário.",
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "Hospedar a página solicitada e enviar o HTML ao navegador do usuário.",
            "Criptografar a conexão HTTPS antes do envio da requisição HTTP.",
            "Armazenar senhas do usuário para preencher formulários automaticamente.",
            "Converter arquivos anexados em mensagens compatíveis com Webmail."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            "criptografar páginas HTTP antes da transmissão ao servidor.",
            "reduzir novas consultas ao armazenar temporariamente respostas de nomes já resolvidos.",
            "transformar automaticamente páginas HTML em documentos PDF.",
            "bloquear todo acesso a sites que utilizem certificados digitais.",
            "substituir o provedor de Internet em conexões de longa distância."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            "armazenar todo o histórico de navegação do usuário em modo privado.",
            "definir a velocidade máxima de download permitida pelo navegador.",
            "associar manualmente nomes de domínio a endereços IP antes da consulta ao DNS.",
            "criar certificados digitais válidos para qualquer site acessado.",
            "registrar mensagens enviadas e recebidas por servidores SMTP."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            "enviar credenciais sempre de forma invisível e fora da URL.",
            "abrir conexão criptografada sem depender de certificado digital.",
            "apagar definitivamente registros no servidor remoto.",
            "solicitar a leitura ou recuperação de um recurso sem enviar corpo de dados principal.",
            "converter automaticamente a resposta HTML para planilha eletrônica."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            "localizar nomes de domínio em servidores autoritativos.",
            "sincronizar mensagens antigas baixadas via POP3.",
            "marcar páginas do navegador como favoritas.",
            "resolver endereço MAC a partir de endereço IPv4.",
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "o recurso foi removido de modo permanente.",
            "a autenticação falhou por senha incorreta.",
            "o servidor exige troca imediata de certificado.",
            "o endereço deve ser resolvido por outro DNS."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            "a página foi encontrada e retornada sem alteração.",
            "o recurso foi movido permanentemente para outro endereço.",
            "o navegador enviou um arquivo grande demais por e-mail.",
            "a senha do usuário expirou no sistema local.",
            "o servidor DNS não possui registros MX."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            "o servidor concluiu a requisição com sucesso.",
            "a conexão HTTPS foi negociada corretamente.",
            "o recurso solicitado não foi encontrado no servidor.",
            "o navegador entrou automaticamente em modo privado.",
            "o arquivo foi transferido por protocolo SMTP."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            "erro de digitação no domínio antes da consulta DNS.",
            "sucesso completo no carregamento do recurso.",
            "redirecionamento temporário para outra URL.",
            "falha interna no servidor ao processar a requisição.",
            "download concluído no computador do usuário."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            "impedir que o site apresente conteúdo falso ou malicioso em qualquer cenário.",
            "eliminar a necessidade de firewall, antivírus e atualizações do sistema.",
            "substituir o DNS por endereços MAC durante a navegação.",
            "garantir que o navegador nunca armazene cookies ou histórico local.",
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "ignorar o alerta, pois certificado expirado indica criptografia reforçada.",
            "desativar o DNS do navegador para validar o cadeado manualmente.",
            "trocar o protocolo para FTP para manter a navegação segura.",
            "usar modo anônimo para renovar o certificado do servidor."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            "aumentar a velocidade de download sem usar cache do navegador.",
            "comprovar a identidade do servidor e apoiar a criação de um canal seguro.",
            "armazenar favoritos e senhas no computador do visitante.",
            "converter automaticamente endereços IPv4 em endereços MAC.",
            "bloquear todos os tipos de phishing que utilizem páginas falsas."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            "um e-mail possui destinatários em CC e CCO na mesma mensagem.",
            "o navegador abre duas abas com domínios de países diferentes.",
            "uma página HTTPS tenta carregar parte de seus recursos por HTTP não protegido.",
            "o DNS responde com registros A e MX simultaneamente.",
            "um download é pausado e retomado por conexão instável."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            "desativar cookies persistentes após fechar todas as abas.",
            "bloquear pesquisas por aspas em mecanismos de busca.",
            "substituir anexos de e-mail por links de armazenamento em nuvem.",
            "usar HTTPS em acessos futuros ao domínio por um período definido.",
            "converter páginas HTML em arquivos compactados ZIP."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            "por qualquer provedor de Internet entre o usuário e o site.",
            "por anexos recebidos em mensagens POP3 arquivadas.",
            "por roteadores domésticos ao distribuir endereços IP.",
            "por arquivos PDF salvos na pasta Downloads do sistema.",
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "envio de e-mails por servidores SMTP autenticados.",
            "mapeamento manual de nomes no arquivo hosts.",
            "sincronização de mensagens por protocolo IMAP.",
            "criação de certificados digitais no computador local."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            "é armazenado somente em servidores DNS autoritativos.",
            "tende a expirar quando a sessão do navegador é encerrada.",
            "é usado apenas para anexar arquivos em mensagens de e-mail.",
            "substitui o histórico de navegação em modo comum.",
            "permite criptografar todo conteúdo HTTP automaticamente."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            "armazenar chaves privadas de certificados de todos os sites visitados.",
            "enviar mensagens ao servidor SMTP sem conexão com a Internet.",
            "guardar cópias locais de recursos para acelerar carregamentos posteriores.",
            "alterar o domínio registrado de um site sem acessar o provedor.",
            "substituir mecanismos de busca por endereços IP fixos."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            "abrir uma nova aba anônima com histórico separado.",
            "salvar todas as senhas em arquivo de texto local.",
            "enviar o endereço atual para todos os favoritos.",
            "recarregar a página ignorando parte do conteúdo armazenado em cache.",
            "consultar automaticamente registros MX do domínio."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            "que o provedor de acesso veja o tráfego sob sua responsabilidade técnica.",
            "que o site identifique endereço IP e informações básicas da conexão.",
            "que administradores da rede monitorem acessos conforme políticas locais.",
            "que páginas HTTPS usem certificados digitais durante a navegação.",
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "armazena senhas criptografadas, enquanto Favoritos armazenam certificados digitais.",
            "substitui o cache de imagens, enquanto Favoritos substituem cookies de sessão.",
            "envia mensagens por SMTP, enquanto Favoritos recebem mensagens por IMAP.",
            "resolve nomes por DNS, enquanto Favoritos hospedam páginas HTML."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            "registrar todos os downloads executados no computador.",
            "armazenar endereços de páginas para acesso posterior mais rápido.",
            "criar conexões criptografadas entre cliente e servidor.",
            "traduzir nomes de domínio para endereços IP públicos.",
            "limpar automaticamente cookies de terceiros após cada acesso."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            "impede que conexões HTTPS utilizem certificados digitais válidos.",
            "bloqueia todos os mecanismos de busca com operadores avançados.",
            "pode inserir dados pessoais em páginas inadequadas ou acessadas por engano.",
            "remove registros DNS armazenados em servidores autoritativos.",
            "transforma arquivos baixados em anexos de correio eletrônico."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            "enviar e-mails sem depender dos protocolos SMTP ou IMAP.",
            "configurar automaticamente o registro de domínio do usuário.",
            "converter arquivos HTML em apresentações de slides.",
            "guardar e preencher credenciais de forma controlada para sites e serviços.",
            "resolver conflitos de versão em documentos colaborativos."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            "alterar a infraestrutura física do provedor de Internet.",
            "substituir certificados digitais emitidos por autoridades públicas.",
            "reduzir automaticamente a distância entre cliente e servidor Web.",
            "impedir que arquivos sejam baixados por qualquer protocolo.",
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "limitar os resultados apenas a arquivos executáveis.",
            "remover automaticamente páginas de redes sociais.",
            "traduzir os resultados para o idioma do navegador.",
            "abrir todos os resultados em janelas anônimas."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            "pesquisar somente dentro de sites governamentais.",
            "remover dos resultados páginas que contenham determinado termo.",
            "forçar a busca por arquivos compactados ZIP.",
            "substituir uma palavra desconhecida por qualquer caractere.",
            "enviar a consulta diretamente a servidores SMTP."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            "buscar apenas páginas que usem criptografia HTTPS.",
            "abrir a página diretamente no modo anônimo.",
            "restringir os resultados a um domínio ou site específico.",
            "listar todos os cookies persistentes salvos localmente.",
            "limpar o cache DNS do sistema operacional."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            "apenas páginas cadastradas como favoritas no navegador.",
            "servidores DNS com autoridade sobre determinado domínio.",
            "mensagens de e-mail arquivadas em uma caixa POP3.",
            "resultados em um formato de arquivo específico, como PDF ou DOCX.",
            "certificados digitais revogados por autoridade certificadora."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            "excluir obrigatoriamente todos os resultados comerciais.",
            "abrir o primeiro resultado sem passar pelo mecanismo de busca.",
            "limpar cookies de terceiros armazenados no navegador.",
            "criptografar a consulta feita ao mecanismo de busca.",
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "substituir o protocolo HTTPS por HTTP em resultados encontrados.",
            "enviar a consulta por e-mail a todos os destinatários em CCO.",
            "listar apenas páginas criadas com linguagem JavaScript.",
            "salvar automaticamente o resultado como favorito do navegador."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            "sincronização de favoritos entre navegadores diferentes.",
            "transferência e envio de mensagens de e-mail entre clientes e servidores.",
            "resolução de nomes de domínio em endereços IPv4.",
            "compactação de anexos para formato ZIP no Webmail.",
            "execução de scripts dentro de páginas HTML."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            "apaga as mensagens do servidor logo após a primeira leitura.",
            "serve apenas para registrar nomes de domínio na Internet.",
            "mantém as mensagens no servidor e sincroniza pastas entre vários dispositivos.",
            "é utilizado para carregar páginas Web por hiperlinks.",
            "substitui o campo CCO em mensagens com vários destinatários."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            "sincronizar continuamente todas as pastas em tempo real como padrão obrigatório.",
            "resolver nomes de sites por consulta a servidores autoritativos.",
            "criptografar conexões Web por meio de certificados TLS.",
            "baixar mensagens para o cliente, podendo removê-las do servidor conforme configuração.",
            "gerenciar favoritos e histórico do navegador local."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            "substituir o DNS no processo de resolução de nomes de domínio.",
            "impedir que mensagens cheguem à pasta de spam em qualquer cenário.",
            "criar conexões VPN entre cliente e servidor de correio.",
            "definir a página inicial padrão de todos os navegadores.",
    ...
    },
    {
        ...
        "alternativas": [
            "remove automaticamente todos os anexos antes do envio.",
            "envia a resposta ao remetente e aos demais destinatários da conversa.",
            "oculta todos os endereços em CCO por padrão.",
            "transforma a mensagem em rascunho sem transmissão.",
            "altera o protocolo de envio de SMTP para DNS."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            "responde apenas ao remetente original sem alterar destinatários.",
            "oculta automaticamente a mensagem da pasta Itens Enviados.",
            "envia o conteúdo recebido para outro destinatário, podendo acrescentar comentário próprio.",
            "converte todos os anexos em registros DNS do domínio.",
            "move a mensagem original para a Lixeira sem confirmação."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            "mensagens recebidas e classificadas como propaganda.",
            "mensagens enviadas com confirmação de leitura aceita.",
            "anexos removidos por limitação de tamanho do servidor.",
            "mensagens iniciadas pelo usuário e ainda não enviadas.",
            "registros DNS consultados durante a navegação Web."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            "apenas a cor do tema usado no cliente de e-mail.",
            "somente o tamanho físico do monitor do destinatário.",
            "exclusivamente a extensão do navegador padrão.",
            "apenas o número de abas abertas no computador.",
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "melhorar a velocidade da conexão por cache local do navegador.",
            "atualizar automaticamente registros de domínio no provedor.",
            "sincronizar favoritos de forma segura entre dispositivos.",
            "converter mensagens POP3 em páginas estáticas HTML."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            "envio de mensagem com cópia visível a todos os destinatários em CC.",
            "redirecionamento indevido para site falso mesmo quando o usuário digita endereço aparentemente correto.",
            "criação de favoritos para páginas acessadas recentemente no navegador.",
            "uso de aspas em pesquisa para localizar frase exata na Web.",
            "download de arquivos da Internet para a pasta padrão do sistema."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            "funciona apenas sem conexão com a Internet após baixar mensagens.",
            "é um protocolo de envio que substitui SMTP em redes corporativas.",
            "permite acessar a caixa postal por meio de navegador, sem aplicativo específico instalado.",
            "serve somente para anexar arquivos compactados em mensagens.",
            "não permite uso de pastas, filtros ou pesquisa por mensagens."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            "transformar a mensagem em spam para reduzir tráfego no servidor.",
            "impedir que destinatários façam download do conteúdo enviado.",
            "substituir o campo assunto por registro DNS do domínio.",
            "contornar limites de tamanho e permitir acesso ao arquivo armazenado remotamente.",
            "abrir a mensagem somente em modo de navegação anônima."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            "armazenar favoritos de navegador em servidor DNS recursivo.",
            "compactar automaticamente todas as mensagens recebidas em ZIP.",
            "substituir o provedor de acesso durante conexão Wi-Fi.",
            "bloquear todos os anexos mesmo quando o remetente é confiável.",
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "garantir que arquivos apagados nunca sejam removidos dos demais dispositivos.",
            "dispensar políticas de senha e autenticação nos serviços usados.",
            "transformar todo documento em anexo de e-mail por padrão.",
            "substituir o backup completo em qualquer cenário corporativo."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            "acelerar a resolução DNS de páginas visitadas recentemente.",
            "recuperar versões anteriores de um arquivo alterado ou editado.",
            "ocultar destinatários em mensagens enviadas com cópia visível.",
            "converter automaticamente HTTP em FTP durante downloads.",
            "substituir a autenticação de dois fatores por cookies."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            "escolher o navegador que terá o histórico apagado automaticamente.",
            "alterar o protocolo SMTP usado pelo destinatário do arquivo.",
            "definir corretamente quem pode acessar e se pode visualizar, comentar ou editar.",
            "bloquear o DNS do domínio para impedir pesquisas externas.",
            "remover a extensão do arquivo para reduzir seu tamanho final."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            "compra apenas cabos físicos para montar uma LAN doméstica.",
            "configura manualmente tabelas de roteamento de um provedor.",
            "recebe somente espaço bruto de processamento sem aplicação instalada.",
            "utiliza um software pronto pela Web, sem administrar a infraestrutura da aplicação.",
            "substitui navegadores por firmware gravado em memória ROM."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            "substituição do DNS por endereços MAC fixos em todas as redes.",
            "envio de e-mails por POP3 sem servidor de correio eletrônico.",
            "acesso garantido a qualquer site sem necessidade de navegador.",
            "eliminação obrigatória de certificados digitais HTTPS.",
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "envia uma cópia completa do vídeo por SMTP antes de assistir.",
            "precisa converter o domínio do serviço em endereço MAC local.",
            "armazena todo o histórico do servidor DNS em cache do navegador.",
            "transforma o conteúdo automaticamente em arquivo compactado ZIP."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            "registro de domínios nacionais em servidores autoritativos.",
            "comunicação em tempo real pelo navegador, como áudio, vídeo e dados.",
            "compactação de anexos de e-mail em formato RAR.",
            "limpeza automática de cookies ao fechar abas comuns.",
            "cálculo de médias em planilhas hospedadas na nuvem."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            "apaga os registros DNS autoritativos de domínios pouco acessados.",
            "substitui todas as conexões HTTPS por HTTP para reduzir latência.",
            "distribui cópias de recursos em servidores próximos aos usuários.",
            "centraliza obrigatoriamente todo conteúdo em um único servidor físico.",
            "impede que navegadores usem cache local durante a navegação."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            "HTML criptografa a página; CSS resolve DNS; JavaScript registra domínios.",
            "HTML transmite e-mail; CSS armazena cookies; JavaScript hospeda arquivos.",
            "HTML compacta imagens; CSS envia anexos; JavaScript troca certificados.",
            "HTML estrutura o conteúdo; CSS define apresentação; JavaScript adiciona comportamento.",
            "HTML controla roteadores; CSS distribui IP; JavaScript substitui protocolos."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            "hyperlink é protocolo seguro; URL é certificado digital do servidor.",
            "hyperlink é servidor DNS; URL é histórico salvo no navegador.",
            "hyperlink é anexo de e-mail; URL é protocolo de recebimento IMAP.",
            "hyperlink é cookie persistente; URL é cache temporário da página.",
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "o protocolo de transporte usado entre cliente e servidor.",
            "o endereço IP público do servidor Web consultado.",
            "a senha criptografada do usuário autenticado.",
            "o servidor SMTP responsável por enviar a página."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            "certificado digital do servidor consultado.",
            "parâmetros de consulta enviados na própria URL.",
            "registro MX usado para envio de e-mail.",
            "arquivo hosts local do computador.",
            "cabeçalho de cópia oculta da mensagem."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            "o site deseja eliminar a necessidade de DNS para qualquer domínio.",
            "o usuário quer transformar uma página em certificado digital.",
            "caracteres especiais ou espaços precisam ser representados de forma válida no endereço.",
            "o navegador precisa enviar mensagem de e-mail por POP3.",
            "o servidor decide apagar o histórico local do visitante."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            "confiar automaticamente, pois QR Code impede páginas falsas.",
            "desativar o HTTPS, pois QR Code já criptografa o conteúdo.",
            "limpar o DNS, pois todo QR Code altera registros autoritativos.",
            "verificar o endereço de destino antes de inserir dados pessoais ou credenciais.",
            "usar CCO, pois QR Code sempre envia e-mail a vários usuários."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            "enviar arquivos do dispositivo local para um serviço remoto.",
            "registrar um domínio em servidor DNS autoritativo.",
            "ocultar destinatários de e-mail em campo apropriado.",
            "salvar um link no navegador como favorito.",
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "recebe do servidor um arquivo PDF para salvar no computador.",
            "marca uma página como favorita para acesso posterior.",
            "consulta o histórico de páginas visitadas no navegador.",
            "limpa cookies armazenados após encerrar a sessão privada."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            "arquivos sincronizados nunca podem ter histórico de versões.",
            "alterações ou exclusões indevidas podem ser replicadas para todos os dispositivos sincronizados.",
            "serviços de nuvem não permitem autenticação por senha.",
            "sincronização funciona apenas em redes sem acesso à Internet.",
            "todo arquivo sincronizado deixa de poder ser compartilhado."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            "enviar mensagens com anexos por protocolo SMTP autenticado.",
            "validar certificados digitais de páginas HTTPS expiradas.",
            "acompanhar atualizações de sites e publicações em um leitor compatível.",
            "compactar páginas Web para reduzir o histórico do navegador.",
            "resolver nomes de domínio em servidores DNS raiz."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            "protocolo para transferência segura de arquivos entre servidores.",
            "mecanismo de busca que localiza somente páginas acadêmicas.",
            "arquivo de configuração usado por navegadores para resolver DNS.",
            "conteúdo de áudio distribuído em episódios, geralmente acessível por assinatura ou plataformas.",
            "campo de e-mail que oculta destinatários de uma mensagem."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            "serve apenas para transmissão de vídeo ao vivo por WebRTC.",
            "funciona somente como cliente de e-mail instalado localmente.",
            "substitui o protocolo HTTPS por páginas estáticas sem certificado.",
            "armazena cookies de terceiros em servidores DNS.",
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "transmite somente áudio e vídeo em chamadas ao vivo.",
            "funciona apenas como mecanismo de busca por arquivos PDF.",
            "exige sempre envio de e-mail por CCO a todos os membros.",
            "resolve domínios sem usar servidores DNS recursivos."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            "criptografar anexos enviados por mensagens SMTP.",
            "dificultar envios automatizados por robôs e scripts.",
            "resolver o endereço IP do servidor Web consultado.",
            "armazenar páginas favoritas no computador local.",
            "substituir a senha por certificado digital obrigatório."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            "elimina todos os riscos de phishing em qualquer página falsa.",
            "substitui o HTTPS durante a transmissão dos dados.",
            "exige um segundo fator além da senha para concluir o acesso.",
            "impede que o usuário receba mensagens de spam.",
            "remove automaticamente cookies persistentes do navegador."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            "negociação de portas TCP usadas por clientes de e-mail.",
            "resolução de nomes pelo arquivo hosts do sistema.",
            "compactação de arquivos antes do download via HTTP.",
            "informação e controle sobre coleta e uso de dados de navegação.",
            "criação de favoritos sincronizados entre navegadores."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            "trocar o provedor de Internet responsável pelo link físico.",
            "mudar o servidor DNS autoritativo de todos os domínios acessados.",
            "criptografar automaticamente páginas HTTP sem certificado.",
            "apagar rascunhos armazenados na conta de e-mail.",
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "remover definitivamente arquivos baixados da pasta Downloads.",
            "cancelar o registro de domínio usado pelos sites visitados.",
            "excluir mensagens da caixa de entrada do Webmail.",
            "desativar o certificado digital de todos os servidores."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            "cria obrigatoriamente uma sessão anônima separada.",
            "abre outra página dentro da mesma janela do navegador.",
            "remove o histórico de navegação automaticamente.",
            "desativa extensões instaladas no navegador.",
            "substitui a URL por endereço IP do servidor."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            "perder automaticamente toda capacidade de monitoramento técnico.",
            "substituir certificados HTTPS por favoritos locais do usuário.",
            "registrar ou controlar acessos conforme suas políticas e infraestrutura.",
            "impedir que servidores DNS respondam consultas autorizadas.",
            "converter qualquer página acessada em arquivo de e-mail."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            "Garante que o site nunca aplicará golpe contra o usuário.",
            "Substitui a necessidade de conferir domínio e conteúdo da página.",
            "Prova que qualquer arquivo baixado está livre de malware.",
            "Indica conexão criptografada, mas não garante sozinho que o site seja honesto.",
            "Impede rastreamento por cookies de terceiros em todos os casos."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            "edição visual do layout de páginas por folhas de estilo.",
            "busca por arquivos PDF em mecanismos de pesquisa.",
            "distribuição de mensagens em listas de discussão por e-mail.",
            "organização local de favoritos e histórico do navegador.",
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "remoção obrigatória de certificados digitais em sites seguros.",
            "envio de e-mails sem uso de servidores de correio.",
            "armazenamento permanente de páginas no arquivo hosts.",
            "transformação de URLs em endereços MAC locais."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            "substituir a função do DNS na localização de domínios.",
            "representar operações sobre recursos, como consultar, criar, atualizar ou remover.",
            "armazenar senhas do navegador em formato de favoritos.",
            "converter mensagens de e-mail em páginas HTML estáticas.",
            "controlar fisicamente cabos de rede conectados ao modem."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            "criptografar automaticamente páginas acessadas por HTTP simples.",
            "registrar domínios governamentais em servidores raiz.",
            "trocar dados estruturados entre sistemas de forma leve e legível por software.",
            "enviar mensagens por POP3 entre clientes e servidores.",
            "armazenar favoritos em forma de imagem compactada."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            "programa local usado apenas para compactar arquivos ZIP.",
            "equipamento físico que converte sinais ópticos em elétricos.",
            "campo de e-mail usado para ocultar destinatários.",
            "serviço acessível pela rede que permite integração entre sistemas.",
            "mecanismo visual para salvar páginas favoritas."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            "indicar servidores responsáveis pelo recebimento de e-mail do domínio.",
            "criar um apelido de um nome para outro nome canônico.",
            "definir texto livre para verificação e políticas do domínio.",
            "mapear um nome diretamente para endereço MAC da placa de rede.",
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "endereços IPv4 usados para abrir páginas Web.",
            "apelidos que apontam um domínio para outro nome.",
            "tempo de permanência de uma resposta em cache.",
            "certificados digitais instalados no navegador local."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            "informar o servidor de e-mail principal de um domínio.",
            "criar um alias que aponta um nome para outro nome canônico.",
            "associar diretamente um nome a endereço IPv4 numérico.",
            "armazenar a senha criptografada dos visitantes do site.",
            "definir a pasta de downloads padrão do navegador."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            "qual porta TCP será usada para envio de e-mail.",
            "o tamanho máximo de arquivo permitido em upload.",
            "por quanto tempo a resposta pode permanecer em cache.",
            "a extensão oficial do arquivo baixado pelo navegador.",
            "a quantidade de abas que podem ficar abertas."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            "histórico local de navegação armazenado no computador.",
            "mensagens excluídas da pasta Lixeira de um Webmail.",
            "senhas salvas no gerenciador do navegador.",
            "registro e dados administrativos de um domínio ou bloco de endereços.",
            "conteúdo de cookies de terceiros em páginas visitadas."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            "limpeza automática de cache para tornar páginas mais rápidas.",
            "uso de CCO para ocultar destinatários em mensagens legítimas.",
            "multiplexação do HTTP/2 para reduzir número de conexões.",
            "armazenamento de favoritos em conta sincronizada do usuário.",
    ...
    },
    {
        ...
        "alternativas": [
            ...
            "impedem completamente o uso de certificados digitais no site final.",
            "transformam todo link em mensagem de e-mail com anexo.",
            "substituem o DNS por endereços MAC dos visitantes.",
            "eliminam a possibilidade de rastreamento em campanhas digitais."
        ],
        "correta": 0,
    ...
    },
    {
        ...
        "alternativas": [
            "registrar domínios em servidores DNS autoritativos.",
            "reduzir o volume de dados transferidos entre servidor e navegador.",
            "ocultar destinatários em mensagens eletrônicas enviadas por CCO.",
            "substituir certificados TLS por senhas do navegador.",
            "impedir que o usuário salve páginas em favoritos."
        ],
        "correta": 1,
    ...
    },
    {
        ...
        "alternativas": [
            "faz o navegador ignorar certificados digitais expirados.",
            "transforma a imagem em anexo automático de e-mail.",
            "permite que leitores de tela descrevam a imagem a usuários com deficiência visual.",
            "substitui o domínio da página por endereço IPv4.",
            "impede que mecanismos de busca encontrem a página."
        ],
        "correta": 2,
    ...
    },
    {
        ...
        "alternativas": [
            "o usuário abre a página em uma aba comum em vez de aba privada.",
            "o navegador resolve o domínio pelo servidor DNS recursivo.",
            "o e-mail é enviado com destinatários no campo CCO.",
            "alterações simultâneas ou offline precisam ser conciliadas pelo serviço.",
            "o site utiliza HTTPS com certificado válido e não expirado."
        ],
        "correta": 3,
    ...
    },
    {
        ...
        "alternativas": [
            "registrar automaticamente domínios em servidores autoritativos sem intervenção.",
            "substituir protocolos de e-mail por mensagens gravadas em cache local.",
            "resolver todos os nomes DNS diretamente pelo arquivo hosts do sistema.",
            "converter páginas HTTPS em arquivos compactados antes do carregamento.",
