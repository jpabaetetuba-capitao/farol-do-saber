...
{
    pergunta: "Durante uma formação pedagógica, uma professora afirmou que a inclusão escolar foi plenamente alcançada porque todos os estudantes com deficiência estavam matriculados em turmas regulares. Outro docente discordou, argumentando que a inclusão exige elementos adicionais. À luz dos princípios da Educação Inclusiva, assinale a alternativa correta:",
    ...
    feedbackAcerto: "Correto. A Educação Inclusiva vai além do acesso físico à escola, envolvendo participação efetiva, aprendizagem, pertencimento e igualdade de oportunidades.",

    feedbackErro: "Uma das maiores pegadinhas em concursos é confundir matrícula com inclusão. Estar presente não significa necessariamente participar e aprender.",

    dicaBanca: "Matrícula ≠ Inclusão. Procure alternativas que mencionem participação, aprendizagem e pertencimento."
},

{
    pergunta: "Uma escola passou a matricular estudantes com deficiência em turmas regulares, porém determinou que eles realizassem quase todas as atividades pedagógicas em salas separadas, retornando à turma apenas em momentos festivos. A equipe gestora classificou a prática como exemplo de inclusão escolar. Considerando os fundamentos da Educação Inclusiva, assinale a alternativa correta:",

    alternativas: [
        "A prática caracteriza inclusão plena porque os estudantes permanecem formalmente matriculados na turma regular.",
        "A prática corresponde ao modelo ideal de Atendimento Educacional Especializado.",
        "A prática garante igualdade de oportunidades ao evitar dificuldades de convivência.",
        "A prática representa integração ou segregação parcial, incompatível com os princípios da inclusão.",
        "A prática é recomendada quando a escola não dispõe de recursos suficientes."
    ],

    correta: 3,

    feedbackAcerto: "Correto. A inclusão exige participação efetiva na vida escolar. A retirada sistemática do estudante do ambiente comum mantém elementos de segregação.",

    feedbackErro: "A presença formal na turma não é suficiente para caracterizar inclusão se a participação ocorre de forma limitada ou isolada.",

    dicaBanca: "A banca costuma trocar inclusão por integração. Inclusão exige convivência e participação reais."
},

{
    ...
    feedbackAcerto: "Correto. A Educação Inclusiva reconhece a diversidade humana e exige transformações na escola para acolher diferentes formas de aprender e participar.",

    feedbackErro: "A lógica inclusiva não busca padronizar estudantes, mas remover barreiras que dificultam sua participação.",

    dicaBanca: "Na inclusão, a escola se adapta à diversidade; não o contrário."
},

{
    ...
    feedbackAcerto: "Correto. A equidade reconhece que diferentes estudantes podem necessitar de diferentes apoios para alcançar oportunidades equivalentes.",

    feedbackErro: "Uma pegadinha clássica é confundir igualdade formal com equidade. A Educação Inclusiva trabalha fortemente com o conceito de equidade.",

    dicaBanca: "Igualdade = mesmo tratamento. Equidade = apoio conforme a necessidade."
},

{
    pergunta: "Ao analisar diferentes concepções de inclusão, uma professora concluiu que determinadas ações escolares beneficiam não apenas estudantes público-alvo da Educação Especial, mas toda a comunidade escolar. Considerando os fundamentos da Educação Inclusiva, assinale a alternativa correta:",
    ...
    feedbackAcerto: "Correto. Ambientes inclusivos promovem participação, convivência, respeito às diferenças e melhoria das oportunidades de aprendizagem para todos.",

    feedbackErro: "A inclusão não beneficia apenas um grupo específico; ela fortalece toda a comunidade escolar.",

    dicaBanca: "Inclusão é uma política para todos, embora garanta apoios específicos quando necessários."
},
{
    pergunta: "Durante uma formação continuada, um professor afirmou que a Educação Especial existe apenas em escolas especializadas e deixou de ter relevância após o avanço da Educação Inclusiva. Considerando a legislação educacional brasileira, assinale a alternativa correta:",
    ...
    feedbackAcerto: "Correto. A Educação Especial é uma modalidade de ensino transversal que atua na perspectiva da Educação Inclusiva.",

    feedbackErro: "Uma pegadinha recorrente é afirmar que a Educação Especial desapareceu ou ficou restrita às instituições especializadas.",

    dicaBanca: "Educação Especial = modalidade; Inclusão = perspectiva."
},

{
    ...
    feedbackAcerto: "Correto. O público-alvo da Educação Especial é composto por pessoas com deficiência, TEA e altas habilidades/superdotação.",

    feedbackErro: "Muitas questões tentam excluir as altas habilidades ou incluir dificuldades de aprendizagem que não fazem parte da definição legal.",

    dicaBanca: "Deficiência + TEA + Altas Habilidades = trio clássico."
},

{
    ...
    feedbackAcerto: "Correto. A legislação reconhece estudantes com altas habilidades/superdotação como público-alvo da Educação Especial.",

    feedbackErro: "Uma das pegadinhas mais comuns é acreditar que a Educação Especial atende apenas estudantes com deficiência.",

    dicaBanca: "Educação Especial não trata apenas de dificuldades; também contempla potencialidades elevadas."
},

{
    ...
    feedbackAcerto: "Correto. O professor regente permanece responsável pelo processo de ensino e aprendizagem de todos os estudantes da turma.",

    feedbackErro: "A Educação Inclusiva pressupõe responsabilidade compartilhada, e não transferência de responsabilidades.",

    dicaBanca: "Professor regente ensina todos os alunos da turma."
},

{
    ...
    feedbackAcerto: "Correto. A Educação Inclusiva reconhece a diversidade existente mesmo dentro do público-alvo da Educação Especial.",

    feedbackErro: "Uma das principais armadilhas é tratar grupos heterogêneos como se fossem homogêneos.",

    dicaBanca: "Inclusão respeita individualidades; não trabalha com soluções padronizadas."
},
{
    pergunta: "Durante uma formação pedagógica, um professor afirmou que o Atendimento Educacional Especializado (AEE) foi criado para substituir a escolarização comum dos estudantes público-alvo da Educação Especial. Considerando a legislação e as políticas inclusivas, assinale a alternativa correta:",
    ...
    feedbackAcerto: "Correto. O Atendimento Educacional Especializado complementa ou suplementa a formação do estudante, sem substituir sua participação na classe comum.",

    feedbackErro: "Uma das pegadinhas mais cobradas em concursos é confundir AEE com substituição da escolarização.",

    dicaBanca: "AEE complementa; escolarização permanece na sala comum."
},

{
    pergunta: "Uma escola encaminhou todos os estudantes público-alvo da Educação Especial para o AEE, independentemente de avaliação individual. A direção argumentou que, por pertencerem ao mesmo grupo, todos possuem necessidades semelhantes. À luz da Educação Inclusiva, assinale a alternativa correta:",
    ...
    feedbackAcerto: "Correto. O planejamento do AEE deve partir das necessidades específicas de cada estudante e não de generalizações sobre grupos.",

    feedbackErro: "A inclusão reconhece a diversidade existente dentro do próprio público-alvo da Educação Especial.",

    dicaBanca: "Necessidade individual vale mais do que o rótulo do grupo."
},

{
    ...
    feedbackAcerto: "Correto. O foco do AEE é eliminar barreiras e ampliar as condições de acesso, participação e aprendizagem do estudante.",

    feedbackErro: "AEE não é sinônimo de reforço escolar nem de repetição do currículo comum.",

    dicaBanca: "AEE trabalha barreiras, acessibilidade e recursos."
},

{
    ...
    feedbackAcerto: "Correto. O AEE é organizado preferencialmente no contraturno, preservando a participação do estudante nas atividades da classe comum.",

    feedbackErro: "Outra pegadinha clássica é transformar o AEE em substituto da escolarização regular.",

    dicaBanca: "Sala comum + AEE, e não sala comum ou AEE."
},

{
    ...
    feedbackAcerto: "Correto. O trabalho colaborativo é um dos fundamentos da Educação Inclusiva e do Atendimento Educacional Especializado.",

    feedbackErro: "A inclusão depende de articulação entre profissionais, família e escola, e não da atuação isolada de um único especialista.",

    dicaBanca: "Palavra-chave do AEE: articulação."
},
{
    pergunta: "Ao visitar uma escola, um gestor observou que a Sala de Recursos Multifuncionais (SRM) estava sendo utilizada como substituta da sala comum para estudantes público-alvo da Educação Especial. A equipe pedagógica justificou a prática afirmando que os alunos aprenderiam melhor em ambientes separados. À luz das políticas inclusivas, assinale a alternativa correta:",
    ...
    feedbackAcerto: "Correto. A Sala de Recursos Multifuncionais destina-se ao AEE e não substitui a participação do estudante na classe comum.",

    feedbackErro: "Uma das maiores pegadinhas é transformar a SRM em substituta da escolarização regular.",

    dicaBanca: "SRM apoia a inclusão; não substitui a sala comum."
},

{
    ...
    feedbackAcerto: "Correto. A Sala de Recursos Multifuncionais apoia o Atendimento Educacional Especializado por meio de recursos pedagógicos e de acessibilidade.",

    feedbackErro: "A SRM não é um espaço de reforço escolar tradicional.",

    dicaBanca: "SRM = recursos e acessibilidade."
},

{
    ...
    feedbackAcerto: "Correto. A SRM deve disponibilizar recursos que favoreçam acesso, participação e aprendizagem dos estudantes.",

    feedbackErro: "Os recursos presentes na SRM têm finalidade inclusiva e não segregadora.",

    dicaBanca: "Tecnologia assistiva e acessibilidade costumam aparecer associadas à SRM."
},

{
    ...
    feedbackAcerto: "Correto. A Sala de Recursos Multifuncionais deve estar articulada ao projeto pedagógico e às ações inclusivas da escola.",

    feedbackErro: "Recursos sem planejamento e articulação dificilmente promovem inclusão efetiva.",

    dicaBanca: "A banca gosta de cobrar integração entre SRM, AEE e sala comum."
},

{
    pergunta: "Ao analisar o funcionamento de uma Sala de Recursos Multifuncionais, uma candidata concluiu que sua finalidade principal é ampliar as condições de acesso, participação e aprendizagem dos estudantes público-alvo da Educação Especial, atuando de forma complementar ao ensino regular. Essa conclusão está:",
    ...
    feedbackAcerto: "Correto. A SRM constitui importante espaço de apoio ao Atendimento Educacional Especializado e à Educação Inclusiva.",

    feedbackErro: "A função da SRM está diretamente relacionada à eliminação de barreiras e ao apoio à participação do estudante.",

    dicaBanca: "SRM + AEE + Inclusão = associação clássica em concursos."
},
{
    ...
    feedbackAcerto: "Correto. Barreiras atitudinais estão relacionadas a preconceitos, discriminação, estigmas e comportamentos que limitam a participação social.",

    feedbackErro: "As políticas inclusivas reconhecem diversos tipos de barreiras, não apenas as físicas.",

    dicaBanca: "Quando o problema está na atitude das pessoas, geralmente trata-se de barreira atitudinal."
},

{
    pergunta: "Uma estudante com deficiência visual recebeu materiais didáticos sem versão digital acessível, sem impressão em Braille e sem recursos compatíveis com leitores de tela. A dificuldade enfrentada por essa estudante está relacionada principalmente à existência de:",
    ...
    feedbackAcerto: "Correto. A ausência de formatos acessíveis compromete o acesso à informação e à comunicação.",

    feedbackErro: "A dificuldade descrita não está relacionada ao espaço físico, mas ao acesso à informação.",

    dicaBanca: "Braille, leitores de tela e formatos acessíveis costumam indicar barreiras comunicacionais."
},

{
    pergunta: "Durante uma visita escolar, observou-se que todos os ambientes eram acessíveis fisicamente. Entretanto, os professores utilizavam exclusivamente métodos expositivos, sem adaptações, recursos alternativos ou estratégias diferenciadas para atender à diversidade da turma. Considerando os princípios da Educação Inclusiva, assinale a alternativa correta:",

    alternativas: [
        "A inclusão está garantida porque as barreiras físicas foram eliminadas.",
        "A acessibilidade arquitetônica é suficiente para assegurar participação e aprendizagem.",
        "Persistem barreiras pedagógicas que podem comprometer o processo de inclusão.",
        "Questões pedagógicas não possuem relação com acessibilidade.",
        "A escola já atende integralmente às exigências inclusivas."
    ],

    correta: 2,

    feedbackAcerto: "Correto. A ausência de estratégias pedagógicas inclusivas pode constituir importante barreira à aprendizagem.",

    feedbackErro: "Uma pegadinha comum é reduzir acessibilidade apenas à infraestrutura física.",

    dicaBanca: "Nem toda barreira é física; muitas estão nas práticas pedagógicas."
},

{
    pergunta: "Uma escola decidiu implantar um sistema digital para matrícula e acompanhamento acadêmico. Contudo, a plataforma não era compatível com leitores de tela, impossibilitando sua utilização por pessoas com deficiência visual. Essa situação caracteriza principalmente:",
    ...
    feedbackAcerto: "Correto. Barreiras tecnológicas surgem quando ferramentas e sistemas não são desenvolvidos de forma acessível.",

    feedbackErro: "A dificuldade descrita está relacionada ao uso de tecnologia e não ao ambiente físico.",

    dicaBanca: "Softwares, aplicativos e plataformas costumam aparecer associados às barreiras tecnológicas."
},

{
    ...
    feedbackAcerto: "Correto. A inclusão exige a remoção de múltiplas barreiras que dificultam acesso, participação e aprendizagem.",

    feedbackErro: "A acessibilidade é um conceito amplo que ultrapassa a dimensão física.",

    dicaBanca: "A banca gosta de cobrar que acessibilidade vai muito além de rampas e elevadores."
},
{
    ...
    feedbackAcerto: "Correto. O DUA busca antecipar a diversidade humana, planejando experiências de aprendizagem acessíveis desde sua concepção.",

    feedbackErro: "Uma das maiores pegadinhas é tratar o DUA como adaptação posterior e não como planejamento preventivo.",

    dicaBanca: "DUA = planejar para a diversidade desde o início."
},

{
    pergunta: "Ao elaborar uma sequência didática, uma professora ofereceu vídeos, textos, infográficos, áudios e simulações interativas para apresentar o mesmo conteúdo. Segundo o Desenho Universal para Aprendizagem, essa estratégia está mais relacionada ao princípio de:",

    alternativas: [
        "Múltiplas formas de avaliação.",
        "Múltiplas formas de segregação curricular.",
        "Flexibilização dos objetivos educacionais.",
    ...
    feedbackAcerto: "Correto. O princípio da representação prevê diferentes formas de apresentar informações e conteúdos aos estudantes.",

    feedbackErro: "A banca costuma confundir representação com avaliação ou adaptação curricular.",

    dicaBanca: "Representação = diferentes formas de apresentar o conteúdo."
},

{
    pergunta: "Durante uma aula, os estudantes puderam demonstrar seus conhecimentos por meio de redação, apresentação oral, vídeo, podcast ou produção de mapas conceituais. Essa prática está alinhada principalmente a qual princípio do DUA?",

    alternativas: [
        "Múltiplas formas de representação.",
        "Múltiplas formas de classificação.",
        "Múltiplas formas de ação e expressão.",
        "Múltiplas formas de intervenção clínica.",
        "Múltiplas formas de avaliação diagnóstica."
    ],

    correta: 2,

    feedbackAcerto: "Correto. O DUA reconhece que diferentes estudantes podem expressar seus conhecimentos de maneiras distintas.",

    feedbackErro: "Expressar o que aprendeu é diferente de receber a informação.",

    dicaBanca: "Ação e expressão = como o estudante demonstra a aprendizagem."
},

{
    pergunta: "Uma escola observou que muitos estudantes apresentavam desinteresse pelas atividades propostas. Em resposta, os professores passaram a oferecer escolhas, desafios graduais, projetos colaborativos e temas relacionados aos interesses dos alunos. Segundo o DUA, essa iniciativa relaciona-se principalmente ao princípio de:",

    alternativas: [
        "Múltiplas formas de representação.",
        "Múltiplas formas de classificação.",
        "Múltiplas formas de adaptação curricular.",
        "Múltiplas formas de engajamento.",
        "Múltiplas formas de atendimento especializado."
    ],

    correta: 3,

    feedbackAcerto: "Correto. O engajamento está relacionado à motivação, interesse, persistência e envolvimento dos estudantes na aprendizagem.",

    feedbackErro: "O DUA não trata apenas de conteúdos e avaliações, mas também de motivação e participação.",

    dicaBanca: "Engajamento = interesse e motivação para aprender."
},

{
    pergunta: "Ao analisar o Desenho Universal para Aprendizagem, uma candidata concluiu que seus três princípios fundamentais consistem em oferecer múltiplas formas de engajamento, representação e ação/expressão. Essa conclusão está:",
    ...
    feedbackAcerto: "Correto. Os três pilares do DUA são engajamento, representação e ação/expressão.",

    feedbackErro: "Grande parte das questões de concurso sobre DUA cobra exatamente esses três princípios fundamentais.",

    dicaBanca: "Decore a tríade: Engajamento + Representação + Ação/Expressão."
},
{
    ...
    feedbackAcerto: "Correto. A avaliação inclusiva busca garantir condições adequadas para que o estudante demonstre suas aprendizagens sem comprometer os objetivos educacionais.",

    feedbackErro: "Uma das maiores pegadinhas é associar avaliação inclusiva à redução automática do nível de exigência.",

    dicaBanca: "Adaptar instrumentos não significa reduzir expectativas."
},

{
    ...
    feedbackAcerto: "Correto. A equidade reconhece que diferentes estudantes podem necessitar de diferentes recursos para acessar as mesmas oportunidades.",

    feedbackErro: "Questões de concurso frequentemente confundem igualdade formal com equidade.",

    dicaBanca: "Tratar todos exatamente da mesma forma nem sempre produz justiça."
},

{
    ...
    feedbackAcerto: "Correto. O objetivo da adaptação é permitir que o estudante demonstre seus conhecimentos de forma acessível e adequada.",

    feedbackErro: "A banca costuma induzir o candidato a acreditar que adaptação significa facilitar ou reduzir conteúdos.",

    dicaBanca: "Avaliação inclusiva remove barreiras, não conhecimento."
},

{
    pergunta: "Uma escola passou a permitir que determinados estudantes realizassem avaliações por meio de apresentação oral, produção de vídeo, mapa conceitual ou atividade prática, conforme suas características e necessidades. Essa prática está alinhada principalmente ao princípio de:",

    alternativas: [
        "Padronização avaliativa.",
        "Segregação pedagógica.",
        "Múltiplas formas de ação e expressão.",
        "Classificação homogênea dos estudantes.",
        "Substituição curricular."
    ],

    correta: 2,

    feedbackAcerto: "Correto. Diferentes formas de expressão permitem que os estudantes demonstrem suas aprendizagens por meios variados.",

    feedbackErro: "A Educação Inclusiva reconhece que nem todos os estudantes expressam conhecimentos da mesma forma.",

    dicaBanca: "Demonstrar aprendizagem = ação e expressão."
},

{
    pergunta: "Ao analisar práticas avaliativas inclusivas, uma candidata concluiu que seu objetivo central é garantir que todos os estudantes tenham oportunidades adequadas de demonstrar suas aprendizagens, respeitando suas características e eliminando barreiras desnecessárias. Essa conclusão está:",
    ...
    feedbackAcerto: "Correto. A avaliação inclusiva busca assegurar participação, acessibilidade e oportunidades justas de demonstração da aprendizagem.",

    feedbackErro: "A avaliação inclusiva não se resume a facilitação, mas à eliminação de barreiras e promoção da equidade.",

    dicaBanca: "Avaliação inclusiva = acessibilidade + equidade + aprendizagem."
},
{
    ...
    feedbackAcerto: "Correto. O professor regente continua responsável pelo processo de ensino e aprendizagem de todos os estudantes da turma.",

    feedbackErro: "Uma das maiores pegadinhas é transferir toda a responsabilidade para o professor do AEE.",

    dicaBanca: "Professor regente ensina todos os alunos; o AEE complementa."
},

{
    ...
    feedbackAcerto: "Correto. Entre as atribuições do professor do AEE estão a identificação de barreiras e a organização de recursos de acessibilidade.",

    feedbackErro: "O AEE possui foco na acessibilidade e na eliminação de barreiras, e não na substituição da escolarização.",

    dicaBanca: "AEE = recursos, acessibilidade e eliminação de barreiras."
},

{
    ...
    feedbackAcerto: "Correto. O profissional de apoio auxilia na autonomia e participação do estudante, sem assumir funções docentes.",

    feedbackErro: "A banca frequentemente tenta transformar o profissional de apoio em professor substituto.",

    dicaBanca: "Apoio escolar ≠ docência."
},

{
    ...
    feedbackAcerto: "Correto. O ensino colaborativo baseia-se na atuação conjunta dos profissionais em benefício de todos os estudantes.",

    feedbackErro: "O coensino não substitui profissionais; ele promove colaboração entre eles.",

    dicaBanca: "Coensino = planejamento e responsabilidade compartilhados."
},

{
    pergunta: "Ao analisar diferentes modelos de organização escolar, uma candidata concluiu que a Educação Inclusiva depende fortemente do trabalho colaborativo entre professores, gestores, profissionais de apoio, famílias e demais especialistas envolvidos no processo educativo. Essa conclusão está:",
    ...
    feedbackAcerto: "Correto. A inclusão efetiva exige articulação entre diferentes profissionais e participação ativa da comunidade escolar.",

    feedbackErro: "A Educação Inclusiva é construída coletivamente e não por um único profissional.",

    dicaBanca: "Inclusão = trabalho colaborativo."
},
{
    ...
    feedbackAcerto: "Correto. A inclusão deve integrar o Projeto Político-Pedagógico como princípio que orienta toda a organização escolar.",

    feedbackErro: "Uma pegadinha comum é restringir a inclusão a setores específicos da escola, quando ela deve estar presente em toda a proposta pedagógica.",

    dicaBanca: "PPP inclusivo envolve toda a comunidade escolar."
},

{
    pergunta: "Uma escola promoveu consultas às famílias, participação estudantil, reuniões de conselhos escolares e avaliação coletiva das ações pedagógicas. Segundo os princípios da Educação Inclusiva, essa prática está mais relacionada ao conceito de:",
    ...
    feedbackAcerto: "Correto. A gestão democrática valoriza participação, diálogo, corresponsabilidade e construção coletiva das decisões educacionais.",

    feedbackErro: "A inclusão exige participação ativa da comunidade escolar e não decisões exclusivamente centralizadas.",

    dicaBanca: "Participação da comunidade = gestão democrática."
},

{
    ...
    feedbackAcerto: "Correto. A parceria entre escola e família é um dos pilares para construção de práticas inclusivas e acompanhamento do desenvolvimento dos estudantes.",

    feedbackErro: "A Educação Inclusiva valoriza o diálogo permanente entre escola e família.",

    dicaBanca: "Família é parceira da escola, não mera espectadora."
},

{
    ...
    feedbackAcerto: "Correto. A inclusão depende também da transformação das atitudes e da cultura institucional da escola.",

    feedbackErro: "Muitas escolas possuem recursos físicos, mas continuam enfrentando barreiras atitudinais e culturais.",

    dicaBanca: "Inclusão não é apenas estrutura; é também cultura."
},

{
    pergunta: "Ao analisar os fundamentos da gestão escolar inclusiva, uma candidata concluiu que a construção de uma escola inclusiva depende da participação da comunidade, da gestão democrática, da valorização da diversidade e do compromisso institucional com a aprendizagem de todos os estudantes. Essa conclusão está:",
    ...
    feedbackAcerto: "Correto. A gestão inclusiva envolve participação coletiva, valorização da diversidade e compromisso com a aprendizagem de todos.",

    feedbackErro: "A Educação Inclusiva possui alcance institucional e depende do engajamento de toda a comunidade escolar.",

    dicaBanca: "Gestão inclusiva = participação + diversidade + aprendizagem para todos."
},
{
    pergunta: "Durante uma avaliação institucional, uma escola apresentou os seguintes resultados: estudantes público-alvo da Educação Especial estavam matriculados em turmas regulares, frequentavam a Sala de Recursos Multifuncionais no contraturno, participavam das atividades da turma e recebiam recursos de acessibilidade quando necessário. Entretanto, eram retirados sistematicamente de projetos, feiras e atividades extracurriculares. À luz da Educação Inclusiva, assinale a alternativa correta:",
    ...
    feedbackAcerto: "Correto. A inclusão exige participação efetiva em todas as dimensões da vida escolar e não apenas nas atividades curriculares formais.",

    feedbackErro: "Uma das principais pegadinhas é confundir presença em sala de aula com participação plena na comunidade escolar.",

    dicaBanca: "Participação e pertencimento vão além das aulas."
},

{
    ...
    feedbackAcerto: "Correto. A Educação Inclusiva trabalha com equidade, reconhecendo que diferentes estudantes podem necessitar de diferentes apoios.",

    feedbackErro: "A banca frequentemente tenta induzir o candidato a confundir igualdade formal com equidade.",

    dicaBanca: "Equidade não é tratar todos exatamente da mesma forma."
},

{
    ...
    feedbackAcerto: "Correto. Inclusão efetiva depende da articulação entre diferentes estratégias, profissionais e recursos.",

    feedbackErro: "A Educação Inclusiva não se apoia em uma única medida isolada, mas em um conjunto articulado de ações.",

    dicaBanca: "Questões integradoras costumam reunir vários conceitos corretos em um mesmo cenário."
},

{
    pergunta: "Durante um concurso público, foi apresentada a seguinte situação: uma escola possui acessibilidade arquitetônica, oferece AEE, mantém Sala de Recursos Multifuncionais e conta com profissionais capacitados. Ainda assim, estudantes público-alvo da Educação Especial são frequentemente subestimados, excluídos de decisões e vistos como incapazes pelos colegas e por parte da equipe escolar. O principal obstáculo à inclusão, nesse caso, é:",

    alternativas: [
        "Barreira arquitetônica.",
        "Barreira tecnológica.",
        "Barreira curricular.",
        "Ausência de Atendimento Educacional Especializado.",
        "Barreira atitudinal."
    ],

    correta: 4,

    feedbackAcerto: "Correto. Preconceitos, estigmas e expectativas reduzidas constituem barreiras atitudinais.",

    feedbackErro: "Mesmo quando existem recursos e acessibilidade física, as barreiras atitudinais podem comprometer profundamente a inclusão.",

    dicaBanca: "Quando o problema está nas crenças e atitudes das pessoas, pense em barreira atitudinal."
},

{
    ...
    feedbackAcerto: "Correto. Essa síntese reúne os principais fundamentos da Educação Inclusiva contemporânea.",

    feedbackErro: "A inclusão vai muito além do acesso físico à escola, envolvendo participação, aprendizagem, pertencimento, equidade e valorização da diversidade.",

    dicaBanca: "Acesso + Participação + Aprendizagem + Pertencimento + Equidade = essência da Educação Inclusiva."
}];